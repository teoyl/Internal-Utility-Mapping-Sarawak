...
public class FrameworkSampleAction extends BaseActionSupport<SampleTableModel> implements ModelDriven<SampleTableModel> {
    public FrameworkSampleAction() {
        setDaoService_(serviceFactory.getSampleService());
        setAction("FrameworkSample"); //Application_code
    ...
    @Override
    public SampleTableModel getModel() {
        return model;
    }
