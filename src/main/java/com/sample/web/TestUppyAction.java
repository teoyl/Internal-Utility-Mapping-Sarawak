...
public class TestUppyAction extends BaseActionSupport<ParentModel> implements ModelDriven<ParentModel> {
    public TestUppyAction() {
        setDaoService_(serviceFactory.getSampleService());
        setAction("UppyGE"); //Application_code
    ...
    public String loadAddPage() {
        try {
            setAction("TestUppy"); //Application_code
            // Your Code Here
        } catch (Exception e) {
