...
><#rt/>
<@s.text name="${parameters.label}"/><#if parameters.dynamicAttributes.get('required')?has_content><font class="asterisk">*</font></#if><#rt/>
</label>
${bsHor_cb_b4Input_}
...
/><label for="${parameters.id?html}"></label>
