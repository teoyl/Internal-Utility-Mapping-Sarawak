...
<#if parameters.id?has_content>
 id="${parameters.id?html}_label"<#rt/>
</#if>
><#rt/>
<@s.text name="${parameters.label}"/><#if parameters.dynamicAttributes.get('required')?has_content><font class="asterisk">*</font></#if></label><#rt/>
${bsHor_rd_b4Input_}
...
<#include "/${parameters.templateDir}/${parameters.expandTheme}/bshor_css.ftl" />
<#include "/${parameters.templateDir}/${parameters.expandTheme}/scripting-events.ftl" />
<#include "/${parameters.templateDir}/${parameters.expandTheme}/common-attributes.ftl" />
<#include "/${parameters.templateDir}/${parameters.expandTheme}/dynamic-attributes.ftl" />
/><#rt/>
<label for="${parameters.id?html}${itemKeyStr?html}"<#include "/${parameters.templateDir}/${parameters.expandTheme}/bshor_css.ftl"/>><#rt/>
    ${itemValue}<#t/>
</label>
</@s.iterator>
${bsHor_cb_close_}<#rt/>