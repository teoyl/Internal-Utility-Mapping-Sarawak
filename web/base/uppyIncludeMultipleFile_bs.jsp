...
'<li><div class="item-content"><div class="item-inner">'+
    ...
    '</div><div class="item-media"><a onclick="removeMe${param.uppyFieldName_}(' + "this" + ",'" + uploadID + "', '" + file.id + "'" + '); return false;"><i class="icon f7-icons">trash</i></a></div></div></li>');
...
'<li><div class="item-content"><div class="item-inner">'+
    ...
    '</div><div class="item-media"><a onclick="removeMe${param.uppyFieldName_}(' + "this" + ",'" + file.meta.drDocId + "', '" + file.id + "'" + '); return false;"><i class="icon f7-icons">trash</i></a></div></div></li>');
