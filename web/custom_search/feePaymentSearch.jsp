                        ...
                        <td width="100%">
                            <table align="left" border="0">
                                <tr id="id1" valign="center">
                                    <td width="20px">&nbsp;</td>
                                    <td class="tdLabel"><s:text name="feeSetup.nature"/></td>
                                    <td>
                                        <s:select theme="simple" name="search_sfee_nature" list='getSearchDDList("sfee_nature_dd")' listKey="code_1" listValue="code_desc" value="%{searchFieldsData[0]}"/>
                                    </td>
                                </tr>
                                <tr id="id1" valign="center">
                                    <td width="20px">&nbsp;</td>
                                    <td class="tdLabel"><s:text name="feeSetup.subNature"/></td>
                                    <td>
                                        <s:textfield theme="simple" name="search_sfee_sub_nature" value='%{searchFieldsData[1]}' size="50"/>
                                        <script language="javascript">
                                            lookup("Search Sub Nature", "SubNature", "code_2", "search_sfee_sub_nature",
                                            "useSetup_SubNature", "code_2,code_desc", "", "true", "search_sfee_nature_as_nature");
                                        </script>
                                    </td>
                                </tr>
                                <tr id="id1" valign="center">
                                    <td width="20px">&nbsp;</td>
                                    <td class="tdLabel"><s:text name="feeSetup.rvrcode"/></td>
                                    <td ><s:textfield theme="simple" name="search_sfee_rvrcode" value="%{searchFieldsData[2]}"/></td>
                                </tr>
                            </table>
                        </td>
                    </tr>
