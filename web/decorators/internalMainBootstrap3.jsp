...
//                                $(".style-switcher2").attr('title', 'Click to show navigation.'); //onload
//                                $(".style-switcher2").click(function() {
//                                    if ($(this).hasClass('visible')) {
//                                        $(".style-switcher2").attr('title', 'Click to show navigation.');
...
//                                });
                                ...
                                //Open Downwards
                                $('.bootstrapDateTimePickerDown').daterangepicker({
                                    "singleDatePicker": true,
                                    "timePicker": true,
                                ...
                                $('.bootstrapDateTimePickerDown').on('apply.daterangepicker', function(ev, picker) {
                                    $(this).val(picker.startDate.format('DD/MM/YYYY hh:mm:ss A'));
                                });
                                //Open Upwards
                                $('.bootstrapDateTimePickerUp').daterangepicker({
                                    "singleDatePicker": true,
                                    "timePickerSeconds": true,
                                    "timePicker": true,  
                                    "showDropdowns": true,
                                ...
                                $('.bootstrapDateTimePickerUp').on('apply.daterangepicker', function(ev, picker) {
                                    $(this).val(picker.startDate.format('DD/MM/YYYY hh:mm:ss A'));
                                });
