...
<html>
<head>
<title><s:set var="systemName_"><s:text name="system.name"/></s:set>
		...
		<center>
			...
			<tr>
                <td align="center" colspan="3">
                    <page:applyDecorator page="/main/publicMainHeader.jsp" name="panel1" />
				</td>
			</tr>
			<tr>
         ...
         <%--<page:applyDecorator page="/main/publicMainFooter.jsp" name="panel1" />--%>
	</center
</body>
<script type="text/javascript" language="javascript">focusFirstColumn();</script>
</html>