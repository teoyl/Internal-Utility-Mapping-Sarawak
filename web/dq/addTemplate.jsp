            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <div class="form-horizontal form-group">
                        <label class="col-md-4 control-label"><s:text name="DqTemplate.selectDs"/> <font class="asterisk">*</font></label>
                        <div class="col-md-5">
                        ...
                        <div class="col-md-3">
                            <button type="button" class="btn btn-primary" name="" id="actionName" onclick="showColumns(); return false;">
                                <i class="fa fa-database"></i><s:text name="DqTemplate.showCols"/>
                            </button>
                        </div>
                    </div>
                    <div class="form-horizontal form-group">
                        <label class="col-md-4 control-label"><s:text name="DqTemplate.tmpl_name"/> <font class="asterisk">*</font></label>
                        <div class="col-md-5">
                    ...
                    <div class="form-horizontal form-group">
                        <label class="col-md-4 control-label"><s:text name="DqTemplate.tmpl_desc"/> <font class="asterisk">*</font></label>
                        <div class="col-md-5">
                    ...
                    <div class="form-horizontal form-group">
                        ...
                        <div class="col-md-5">
                            <button type="submit" class="btn btn-primary" name="action:add_step2DqTemplate" id="actionName" onclick="">
