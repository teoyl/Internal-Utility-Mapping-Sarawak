                            ...
                            <tbody>
                                <s:iterator value="model.templateFieldList" var="field" status="fieldStatus">
                                    <tr id="row-${fieldStatus.index+1}" class="templateFieldRow">
                                        ...
                                        <td>
                                            <s:hidden class="rowOrder" id="order_row-%{#fieldStatus.index+1}" value="%{#field.fld_order}" name="model.templateFieldList[%{#fieldStatus.index}].fld_order" cssClass="form-control"/>
                ...
                <div class="kt-portlet__foot">
                    <div class="kt-form__actions">
                        <div class="form-horizontal form-group">
                            <div class="col-md-5">
                                <button type="button" class="btn btn-brand" name="action:goEditPageDqTemplate" id="actionName" onclick="submitTemplateForm('goEditPageDqTemplate')">
                                    <i class="fa fa-toggle-left"></i><s:text name="DqTemplate.previous"/>
                                </button>
                                <button type="button" class="btn btn-brand" name="action:processUpdateDqTemplate" id="actionName" onclick="submitTemplateForm('processUpdateDqTemplate')">
