    ...
    <div class="card">
        ...
        <div class="card-body">
                        ...
                        <s:iterator value="model.templateFieldList" var="field" status="fieldStatus">
                            <tr id="row-${fieldStatus.index+1}" class="templateFieldRow">
                                ...
                                <td class="align-middle white-space-nowrap">
                                    <div class="form-check fs-0">
                                        <input class="cbShowMe form-check-input" type="checkbox" <s:if test="#field.fld_showMe_boo">checked</s:if> value="Y" name="model.templateFieldList[${fieldStatus.index}].fld_showMe" id="_${fieldStatus.index}" onclick="toggleSelectAll('cbShowMe')"/>
                                        <label for="_${fieldStatus.index}" class="form-check-label"></label>
                                    </div>
            ...
            <div class="row mb-1">
                ...
                <div class="col-md-5">
                    <button type="button" class="btn btn-sm btn-primary" name="action:loadAddPageDqTemplate" id="actionName" onclick="submitTemplateForm('loadAddPageDqTemplate')">
                        <i class="far fa-caret-square-left"></i> <span class="ms-1"><s:text name="DqTemplate.previous"/></span>
                    </button>
                    <button type="button" class="btn btn-sm btn-primary" name="action:processInsertDqTemplate" id="actionName" onclick="submitTemplateForm('processInsertDqTemplate')">
