    ...
    <body>
        ...
        <form id="dqTemplateFormId" method="post" action="processUpdateDqTemplate">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <div class="row mb-1">
                        <label class="col-md-4 col-form-label col-form-label-sm"><s:text name="DqTemplate.selectDs"/> <font class="asterisk">*</font></label>
                        <div class="col-md-5">
                    ...
                    <div class="row mb-1">
                        <label class="col-md-4 col-form-label col-form-label-sm"><s:text name="DqTemplate.tmpl_name"/> <font class="asterisk">*</font></label>
                        <div class="col-md-5">
                            <s:textfield cssClass="form-control form-control-sm" name="tmpl_name" value="%{model.tmpl_name}" required="required"/>
                        </div>
                    </div>
                    <div class="row mb-1">
                        <label class="col-md-4 col-form-label col-form-label-sm"><s:text name="DqTemplate.tmpl_desc"/> <font class="asterisk">*</font></label>
                        <div class="col-md-5">
                            <s:textfield cssClass="form-control form-control-sm" name="tmpl_desc" value="%{model.tmpl_desc}" required="required"/>
                        </div>
                    </div>
                    <div class="row mb-1">
                        <label class="col-md-4 col-form-label col-form-label-sm">Condition</label>
                        <div class="col-md-5">
                    ...
                    <div class="row mb-1">
                        ...
                        <div class="col-md-5">
                            <button type="submit" class="btn btn-sm btn-primary" name="action:edit_step2DqTemplate" id="actionName" onclick="">
