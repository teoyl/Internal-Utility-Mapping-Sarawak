        ...
        <form id="dqTemplateFormId" method="post" action="processUpdateDqTemplate">
            ...
            <div class="panel panel-default">
                <div class="panel-heading">
                    <h4><s:text name="DqTemplate.appName"/> <small><s:text name="actionType.edit"/></small></h4>
                </div>
                <div class="panel-body">
                    ...
                    <div class="form-horizontal form-group">
                        ...
                        <div class="col-md-5">
                            <button type="submit" class="btn btn-primary" name="action:edit_step2DqTemplate" id="actionName" onclick="">
