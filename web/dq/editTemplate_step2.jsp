            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    ...
                    <div class="form-horizontal form-group">
                        ...
                        <div class="col-md-5">
                            <button type="button" class="btn btn-primary" name="action:goEditPageDqTemplate" id="actionName" onclick="submitTemplateForm('goEditPageDqTemplate')">
                                <i class="fa fa-toggle-left"></i><s:text name="DqTemplate.previous"/>
                            </button>
                            <button type="button" class="btn btn-primary" name="action:processUpdateDqTemplate" id="actionName" onclick="submitTemplateForm('processUpdateDqTemplate')">
