    ...
    $.sessionTimeout = function(options) {
        ...
        if (typeof opt.onWarn !== 'function') {
            ...
            var coundownBarHtml = opt.countdownBar ?
                '<div class="progress"> \
                  <div id="pBar_id" class="progress-bar progress-bar-striped countdown-bar active" role="progressbar" style="min-width: 15px; width: 100%;"> \
                    <span id="holder_id" class="countdown-holder"></span> \
                  </div> \
                </div>' : '';

            // Create timeout warning dialog
            $('body').append('<div class="modal fade" id="session-timeout-dialog" data-backdrop="static" data-keyboard="false"> \
...
//            $('#session-timeout-dialog').on('hide.bs.modal', function() {
            $('#session-timeout-dialog').on('hidden', function() {
                opt.timeout_flag = false;
        ...
        function startDialogTimer() {
            ...
            timer = setTimeout(function() {
                ...
                if (opt.stayAtPage) {
                    opt.timeout_flag = true;
                    $("#pBar_id").css({
                        "min-width": "100%", 
                        "width": "100%"
                    });
                    $("#holder_id").text(opt.timesUpText);
                } else {
