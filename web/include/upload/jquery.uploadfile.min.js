 ...
 * http://hayageek.com/
 * amended by amywyp on espaDelete on 13-03-2018
 */
(function($) {
    if ($.fn.ajaxForm == undefined) {
//        $.getScript(("https:" == document.location.protocol ? "https://" : "http://") + "malsup.github.io/jquery.form.js");
        $.getScript("include/upload/jquery.form.js");
    }
    var feature = {};
    ...
    $.fn.uploadFile = function(options) {
        ...
        var s = $.extend({
            ...
            espaDelete: function(obj, files, pd) {},
            espaDownload: function(obj, files, pd) {},
            serialize: true,
            sequential: false,
            sequentialCount: 2,
...
//                        s.downloadCallback.call(obj, [filename], pd);
                    if (s.espaDownload)
                        s.espaDownload.call(this, obj, [filename], pd);
                });
            }
            if (s.showDelete)
            {
...
//                	if(s.deleteCallback) s.deleteCallback.call(this, arr, pd);
                    if (s.espaDelete)
                        s.espaDelete.call(this, obj, arr, pd);
                    obj.selectedFiles -= 1;
        ...
        function updateFileCounter(s, obj) {
            if (s.showFileCounter) {
                ...
                obj.fileCounter = 1; //always shows count=1 amended by amywyp @ 13-03-2018
        ...
        function createCustomInputFile(obj, group, s, uploadLabel) {
            ...
            fileInput.change(function() {
                ...
                if (this.files) //support reading files
                {
                    ...
                    if (s.onSelect(this.files,obj) == false)
                        return;
                } else {
...
//            this.preview = $("<img class='ajax-file-upload-preview' />").width(s.previewWidth).height(s.previewHeight).appendTo(this.statusbar).hide();
            ...
            this.preview = $("<div>" + s.previewStr + "</div>").appendTo(this.statusbar).hide();
            ...
            this.preview.addClass("ajax-file-upload-blue")
...
//                                    if(s.deleteCallback) s.deleteCallback.call(this, data, pd);
                                    if (s.espaDelete)
                                        s.espaDelete.call(this, obj, fileArray, pd);
                                    obj.selectedFiles -= fileArray.length; //reduce selected File count
                                    updateFileCounter(s, obj);
                                } else {
                                    return false;
...
//                                s.downloadCallback(data, pd);
                            if (s.espaDownload)
                                s.espaDownload.call(this, obj, fileArray, pd);
                        });
                    }
