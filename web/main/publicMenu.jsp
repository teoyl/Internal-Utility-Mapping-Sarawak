...
<body>
	...
	if (treeList == null) treeList = "";
        ...
        //System.out.println("Wongkk - strAction " + strAction);
   ...
   <table align="center" border="0" cellpadding="0" cellspacing="0" width="1000px">
        <tr>
            ...
            <td valign="top" align="right" width="50px">
                <a href="logoutPublicRegistration" title="<s:text name="common.logout"/>"><img src="images/imp_logout.png" alt="Logout"/></a>
            </td>
        </tr>
    </table>
</body>
