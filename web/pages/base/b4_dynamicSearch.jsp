...
<s:if test='useDataTable'>
    ...
    <link href="include/assets/plugins/custom/datatables/datatables.bundle.css" rel="stylesheet" type="text/css" />
    <style>
        ...
        table.columns().iterator( 'column', function (ctx, idx) {
            ...
            var KTDatatablesBasicBasic = function () {
                ...
                var initTable1 = function () {
                    ...
                    // begin first table
                    var aoColumns = [];
                    $('#kt_table_1 thead th').each( function () {
                            ...
                            thead.getElementsByTagName('th')[0].innerHTML = `
                                    <label class="kt-checkbox kt-checkbox--single kt-checkbox--brand">
                                        <s:if test="result.size() > 0">
                                            <input type="checkbox" value="" class="selectAll" id="cbselect" name="cbselect" onClick="toggleCheckboxByName(this,'selected');">
                                        </s:if><s:else>
...
//                                    return `
//                                            <label class="kt-checkbox kt-checkbox--single kt-checkbox--brand">
//                                                <input type="checkbox" class="kt-checkable" name="selected" value="<s:property value='%{getResultPrimaryKey(#resultStatus.index)}' escapeHtml='true'/>" onclick="toggleSelectAll()" />
//                                                <span></span>
//                                            </label>`;
//                                }
                            }
    ...
    <div class="kt-portlet">
                        ...
                        <form action="search2Dynamic" name="${mcfAction}search2DynamicFormId" id="${mcfAction}search2DynamicFormId" method="POST">
                            ...
                            <div class="col-md-8">
                                <s:if test="#mcfActionStatus.index == 0 ">
                                    <div class="row">
                                        <div class="col-3 col-form-label">Please Select</div>
                                        <div class="col-9 rowText"><s:select onchange="searchCodeChange(this.value)" theme="simple" cssStyle="form-control input-sm" id="mainSearchCode" cssClass="form-control mySelectBox" name="searchCode" list='mixedConfig_map.get("mainSearchCodeDD").get("searchCode_dd")' listKey="keyData" listValue="valueData" value='%{searchCode}' /></div>
                                    </div>
                                </s:if>
                                    ...
                                    <s:iterator value='%{mixedConfig_map.get(#mcfAction+"searchFields")}' var="field" status="rowStatus">
                                        ...
                                        <s:else>
                                            <div class="form-group row">
                                                <div class="col-3 col-form-label"><s:property value='%{mixedConfig_map.get(#mcfAction+"searchFieldsLabel")[#rowStatus.index]}'/></div>
                                                <div class="col-9">
                                                    <s:set var="searchfield_dd_type">${field}_dd_type</s:set>
                                                    <s:set var="searchfield_dd_key">${field}_dd_key</s:set>
                                                    ...
                                                    <s:elseif test='mixedConfig_map.get(#mcfAction+"searchFieldDD").get(#searchfield_dd_key) != null'>
                                                        ...
                                                        <s:else>
                                                            <s:if test='mixedConfig_map.get(#mcfAction+"searchFieldDD").get(#searchfield_dd_list).equalsIgnoreCase("setupcode")'>    <%--Added by Delvene @ 29-Aug-2013--%>
                                                                <s:select theme="simple" cssClass="form-control kt-select2" name="search_%{#field}" list='mixedConfig_map.get(#mcfAction+"searchFieldDD").get(#searchfield_dd)' listKey="code_id" listValue="code_desc" value='%{searchFieldsDataMap.get("search_"+#field)}' />
                                                            </s:if>
                                                            <s:else>
                                                                <s:select theme="simple" cssClass="form-control kt-select2" name="search_%{#field}" list='mixedConfig_map.get(#mcfAction+"searchFieldDD").get(#searchfield_dd)' listKey="keyData" listValue="valueData" value='%{searchFieldsDataMap.get("search_"+#field)}' />
                                                            </s:else>
                                                        </s:else>
                                                    </s:elseif>
                            ...
                            <div class="col-md-4 text-right">
                                <s:if test="#mcfActionStatus.index == 0">
                                    <button class="btn btn-brand" type="submit" onclick="return getPageSize('_mc', this.form);"><i class="fa fa-search"></i>&nbsp;<s:text name="button.search"/></button>
        ...
        <s:else>
            <form action="search2Dynamic" id="search2DynamicFormId" method="POST" >
                <div class="kt-portlet__head">
                    <div class="kt-portlet__head-label">
                        <h3 class="kt-portlet__head-title pull-left">
                            ${searchDescription}
                        </h3>
                    </div>
                    <div class="kt-portlet__head-toolbar">
                        <s:if test='hideAddButton.equals("N")'>
                            <s:if test="has_right('loadAddPage')">
                                <button class="btn btn-outline-brand" type="button" onclick="submitForm('search2DynamicFormId', '${addPageURL}')" name="action:${addPageURL}" id="${addPageURL}"><i class="fa fa-plus"></i><s:text name="button.add"/></button>
                        ...
                        <s:if test='hideDeleteButton.equals("N")'>
                            <s:if test="has_right('delete')">
                                <button class="btn btn-outline-brand" type="button" name="action:${deleteURL}" id="${deleteURL}" onclick="if (isCheckboxSelected(document.getElementById('listForm').selected)) {
                                    if (confirmDelete()) {
                                    ...
                                    return false;
                                }"><i class="fa fa-trash"></i><s:text name="button.delete"/></button>
                        ...
                        <s:if test="additionalButton.size() > 0">
                            <s:iterator value="additionalButton" var="addButton" status="addButtonStatus">
                                <s:if test="additionalButtonChecked[#addButtonStatus.index]">
                                    <button class="btn btn-outline-brand" type="button" onclick="
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-8">
                                        ...
                                        <div class="col-9">
                                            ...
                                            <s:if test='#field.startsWith("_date_")'>
                                                <s:if test='#field.endsWith("_fromTo")'>
                                                    ...
                                                    <s:if test='searchFieldsMap.containsKey(#searchfield_splitDate)'>
                                                        <div class="row">
                                                            <div class="col-md-6">
                                                                <div class="input-group date">
                                                                    <s:textfield cssClass="dsrf form-control DateRange SameDate" theme="simple" id="search_%{#field.substring(6, (#field.length() - 7))}From" name="search_%{#field.substring(6, (#field.length() - 7))}From" value='%{searchFieldsDateData.get("search_"+extractSearchFieldForDate(#field)+"From")}'/>
                                                                    <%--<input class="form-control DateRange SameDate" id="datepickerFrom" name="datepickerFrom" value='' required>--%>
                                                            ...
                                                            <div class="col-md-6">
                                                                <div class="input-group date">
                                                                    <%--<input class="form-control DateRange SameDate" id="datepickerTo" name="datepickerTo" value='' required>--%>
                                                                    <s:textfield cssClass="dsrf form-control DateRange SameDate" theme="simple" id="search_%{#field.substring(6, (#field.length() - 7))}To" name="search_%{#field.substring(6, (#field.length() - 7))}To" value='%{searchFieldsDateData.get("search_"+extractSearchFieldForDate(#field)+"To")}'/>
                                                                    <div class="input-group-append">
                                                                        <span class="input-group-text">
                                                                            <i class="fa fa-calendar-check-o"></i>
                                                                        </span>
                                                ...
                                                <s:else>
                                                    ...
                                                    <div class="input-group date">
                                                        <s:textfield cssClass="form-control DateRange" id="" theme="simple" name="search_%{#field.substring(6)}" value='%{searchFieldsDateData.get("search_"+extractSearchFieldForDate(#field))}'/>
                                                        <div class="input-group-append">
                                                            <span class="input-group-text">
                                                                <i class="fa fa-calendar-check-o"></i>
                                                            </span>
                                            ...
                                            <s:elseif test='getSearchFieldDD().get(#searchfield_dd_key) != null'>
                                                ...
                                                <s:else>
                                                    <div id="${field}Div">
                                                    <s:if test="getSearchFieldDD().get(#searchfield_dd_list).equalsIgnoreCase('setupcode')">    <%--Added by Delvene @ 29-Aug-2013--%>
                                                        <s:select theme="simple" cssClass="dsrfdd rowText form-control sds-dropdown mySelectBox input-sm kt-select2" name="search_%{#field}" id="search_%{#field}" list="getSearchDDList(#searchfield_dd)" listKey="code_id" listValue="code_desc" value='%{searchFieldsDataMap.get("search_"+#field)}' />
                                                    </s:if>
                                                    <s:else>
                                                        <s:if test='searchFieldsMap.containsKey(#searchfield_itemChange)'>
                                                            <s:select theme="simple" cssClass="dsrfdd form-control kt-select2" name="search_%{#field}" id="search_%{#field}" list="getSearchDDList(#searchfield_dd)" listKey="keyData" listValue="valueData" value='%{searchFieldsDataMap.get("search_"+#field)}' onchange='itemChange(%{searchFieldsMap.get(#field+"_itemChange")})'/>
                                                        </s:if><s:else>
                                                            <s:select theme="simple" cssClass="dsrfdd form-control kt-select2" name="search_%{#field}" id="search_%{#field}" list="getSearchDDList(#searchfield_dd)" listKey="keyData" listValue="valueData" value='%{searchFieldsDataMap.get("search_"+#field)}' />
                                                        </s:else>
                                                    </s:else>
                                                    </div>
                                                </s:else>
                                            ...
                                            <s:elseif test='getSearchFieldLookup().get(#searchfield_lookupSearch) != null'>
                                                <div class="input-group">
                                                    ...
                                                    <div class="input-group-append"><span class="input-group-text" id="basic-addon2" onclick="<s:property value="%{getSearchFieldLookup().get(#searchfield_lookupSearch)}"/>"><i class="fa fa-search"></i></span></div>
                                                </div>
                            ...
                            <s:iterator value="moreSearchFields" var="field" status="rowStatus">
                                ...
                                <s:else>
                                    <div class="form-group row moreField">
                                        ...
                                        <div class="col-9">
                                            ...
                                            <s:elseif test='getSearchFieldDD().get(#searchfield_dd_key) != null'>
                                                ...
                                                <s:else>
                                                    <s:if test="getSearchFieldDD().get(#searchfield_dd_list).equalsIgnoreCase('setupcode')">    <%--Added by Delvene @ 29-Aug-2013--%>
                                                        <s:select theme="simple" cssClass="dsrfdd rowText form-control mySelectBox input-sm kt-select2" name="search_%{#field}" list="getSearchDDList(#searchfield_dd)" listKey="code_id" listValue="code_desc" value='%{searchFieldsDataMap.get("search_"+#field)}' />
                                                    </s:if>
                                                    <s:else>
                                                        <s:select theme="simple" cssClass="dsrfdd rowText form-control mySelectBox input-sm kt-select2" name="search_%{#field}" list="getSearchDDList(#searchfield_dd)" listKey="keyData" listValue="valueData" value='%{searchFieldsDataMap.get("search_"+#field)}' />
                                                    </s:else>
                                                </s:else>
                                            </s:elseif>
                                            <s:elseif test='getSearchFieldLookup().get(#searchfield_lookupSearch) != null'>
                                                <div class="input-group">
                                                    <s:textfield theme="simple" cssClass="form-control" id="search_%{#field}" name="search_%{#field}" value="%{searchFieldsDataMap[#searchfield_]}" size="30"/>
                                                    <div class="input-group-append"><span class="input-group-text" id="basic-addon2" class="input-group-append" onclick="<s:property value="%{getSearchFieldLookup().get(#searchfield_lookupSearch)}"/>"><i class="fa fa-search"></i></span></div>
                                                </div>
                                                <%--s:textfield theme="simple" name="search_%{#field}" value="%{searchFieldsData[#rowStatus.index]}" size="30" cssClass="form-control input-sm" cssStyle="width: 292px; padding: 1px 3px 1px 3px;"/>
                                                 <script language="javascript">
                                                    <s:property escape="false" value="%{getSearchFieldLookup().get(#searchfield_lookupSearch)}"/>
                                ...
                                <s:if test='showPageSize && !(useDataTable)'>
                                    <div class="form-group row">
                                        <div class="col-3 col-form-label"><s:text name="paging.recordPerPage"/></div>
                                        <div class="col-9">
                                            <s:select theme="simple" id="mainPageSize" name="mainPageSize" list="pageSizeOption" listKey="keyData" listValue="valueData" value="%{pageSize}" cssClass="dsrfdd form-control input-sm kt-select2"/>
                                        </div>
                                    </div>
                                </s:if>
                        </div>
                        <!--right box-->
                        <div class="col-md-4 text-right">
                            <button class="btn btn-brand" type="submit" onclick="getPageSize('', this.form); submitForm('search2DynamicFormId', 'search2Dynamic')"><i class="fa fa-search"></i>&nbsp;<s:text name="button.search"/></button>
                            <button class="btn btn-outline-brand reset" type="button" onclick="resetFields(this.form)"><i class="fa fa-undo"></i>&nbsp;<s:text name="button.reset"/></button>
                            <s:if test="has_right('dynamicSearchRpt')">
                                <%--<div class="btn-group">
                                ...
                                <button type="button" class="btn btn-outline-brand" data-toggle="dropdown">
                                    <i class="fa fa-print"></i>&nbsp;<s:text name="button.print"/>&nbsp;&nbsp;<i style="font-size:13px" class="fa fa-caret-down"></i>
                                </button>
                                <div class="dropdown-menu dropdown-menu-right" x-placement="bottom-end" style="position: absolute; will-change: transform; top: 0px; left: 0px; transform: translate3d(-58px, 38px, 0px);min-width:10rem;padding:0;">
                                    <ul class="kt-nav">
                                        <li class="kt-nav__item"><a class="kt-nav__link" onclick="printRpt('pdf')" href="#"><i class="kt-nav__link-icon fa fa-file-pdf-o"></i><span class="kt-nav__link-text">PDF</span></a></li>
                                        <li class="kt-nav__item"><a class="kt-nav__link" onclick="printRpt('excel')" href="#"><i class="kt-nav__link-icon fa fa-file-excel-o"></i><span class="kt-nav__link-text">Excel</span></a></li>
                                    </ul>
                                </div>
                            </s:if>
                            <s:if test="hasMoreSearchField">
        ...
        <jsp:include page="b4_actionError.jsp"></jsp:include>
                                    ...
                                    <s:if test='!("Y".equals(mixedConfig_map.get(#mcfAction+"hideAddButton"))) || !("Y".equals(mixedConfig_map.get(#mcfAction+"hideDeleteButton")))'>
                                        <s:if test='!"Y".equals(mixedConfig_map.get(#mcfAction+"hideAddButton"))'>
                                            <s:if test="has_right2('DynamicAction','loadAddPage',#mcfAction)">
                                                <button class="btn btn-outline-brand" type="submit" name="action:<s:property value='%{mixedConfig_map.get(#mcfAction+"addPageURL")}'/>" id="<s:property value='%{mixedConfig_map.get(#mcfAction+"addPageURL")}'/>"><i class="fa fa-plus"></i><s:text name="button.add"/></button>
                                            ...
                                            <s:if test='!"Y".equals(mixedConfig_map.get(#mcfAction+"hideDeleteButton"))'>
                                                ...
                                                <button class="btn btn-outline-brand" type="submit" name="action:<s:property value='%{mixedConfig_map.get(#mcfAction+"deleteURL")}'/>" 
