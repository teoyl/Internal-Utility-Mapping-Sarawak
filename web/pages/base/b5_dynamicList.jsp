            ...
            <tr>
                <s:if test='dl_showCheckbox || hideDeleteButton.equals("N")'>
                    ...
                    <s:if test="has_right2('DynamicAction','delete',action)">
                        <th style="width:1%;" class="white-space-nowrap <s:if test="useDataTable">no-sort</s:if>">
            ...
            <s:if test="result.size() > 0">
                ...
                <s:iterator value="result" status="resultStatus" var="r">
                    <tr>
                        <s:if test='dl_showCheckbox || hideDeleteButton.equals("N")'>
                            <s:if test="has_right2('DynamicAction','delete',action)">
                                <td class="white-space-nowrap <s:if test="#resultStatus.odd == true ">odd</s:if><s:else>even</s:else>" width="1%">
                                    <div class="form-check fs-0 mb-0 d-flex align-items-center">
                                        <input class="form-check-input checkbox_child" type="checkbox" name="selected" id="_${resultStatus.index}" value="<s:property value="%{getResultPrimaryKey(#resultStatus.index)}" escapeHtml="true"/>" onclick="toggleSelectAll()" />
                                    </div>
                                    <%firstIndex++;%>
                                </td>
                            </s:if>
                        ...
                        <s:iterator value="displayFields" var="displayCol">
                            <td class="align-middle white-space-nowrap" id="${displayCol}" style="word-wrap: break-word; <s:property value='%{getFieldStyleFormat(#displayCol, "detail", #r.get(#displayCol), #r)}' escapeHtml="true"/>">
