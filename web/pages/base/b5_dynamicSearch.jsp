...
<!--                                                <div class="form-group form-group-default">
                        ...
                        <s:iterator value="moreSearchFields" var="field" status="rowStatus">
                            ...
                            <s:if test='showPageSize && !(useDataTable)'>
                                <div class="row mb-1">
                                    <label class="col-md-4 col-form-label col-form-label-sm"><s:text name="paging.recordPerPage"/></label>
                                    <div class="col-md-8">
                    ...
                    <div class="col-md-4 text-end">
                        <button class="btn btn-primary btn-sm mb-1" type="submit" onclick="getPageSize('', this.form); return submitSearch('search2DynamicFormId', 'search2Dynamic');"><i class="fa fa-search"></i><span class="ms-1"><s:text name="button.search"/></span></button>
                        <button class="btn btn-falcon-default reset btn-sm mb-1" type="button" onclick="resetFields(this.form)"><i class="fa fa-undo"></i><span class="ms-1"><s:text name="button.reset"/></span></button>
                        <s:if test="has_right('dynamicSearchRpt')">
                            <div class="btn-group">
                                <button type="button" class="btn btn-falcon-default dropdown-toggle btn-sm mb-1" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                    <i class="fa fa-print"></i><span class="ms-1"><s:text name="button.print"/></span>
                                </button>
                                <div class="dropdown-menu py-1">
                                    <a class="dropdown-item" onclick="printRpt('pdf')" href="#"><i class="far fa-file-pdf"></i><span class="ms-1">PDF</span></a>
                                    <a class="dropdown-item" onclick="printRpt('excel')" href="#"><i class="far fa-file-excel"></i><span class="ms-1">Excel</span></a>
                                </div>
                            </div>
                        </s:if>
                        <s:if test="hasMoreSearchField">
                            <button class="btn btn-falcon-default showHide btn-sm mb-1" type="submit" onclick="return showHideMoreField();"><i class="showHideIcon fa <s:if test='showHideMoreField_.equals("H")'>fa-arrow-down</s:if><s:else>fa-arrow-down</s:else> search"></i><span class="ms-1"><s:text name="button.more"/></span></button>
