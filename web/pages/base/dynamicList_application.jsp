            ...
            <tr class="bottom-green-2">
                ...
                <s:if test="moreInfoType!=null">
                    ...
                    <th style="text-align: center; width: 1%">
                        <span><s:text name="utimaps.appSearch.case_history" /></span>
                    </th>
                </s:if>
                    ...
                    <tr class="bottom-green-1">
                                    ...
                                    <s:elseif test='#displayFieldLink_btn.contains("@@")'>
                                        ...
                                        <s:if test="!(#r.get(#displayCol) == null)">
                                            <s:if test='(#r.containsKey("errId"))'>
                                                ...
                                                <s:a href="%{displayFieldLink}" cssStyle="%{lDisplayStyle}" target="%{theTarget}"><div style="width: 100%"><s:property escapeHtml="true" value="%{#r.get(#displayCol)}"/></div></s:a>
                                            </s:else>
                                        </s:if>
                                    </s:else>
                                </s:elseif>
                        ...
                        <s:if test="moreInfoType!=null">
                            <td class="text-middle align-middle ">
                                ...
                                <button title="<s:text name="button.viewMoreInfo"/>" class="no-bg-btn word-green" onclick="openMoreInfo('USJ', '<s:property value="%{getResultPrimaryKey(#resultStatus.index)}" escapeHtml="true"/>'); return false;">
