                    ...
                    <s:if test="additionalButton.size() > 0">
                        <s:iterator value="additionalButton" var="addButton" status="addButtonStatus">
                            <s:if test="additionalButtonChecked[#addButtonStatus.index]">
                                <button class="btn btn-default pull-right pull-right3" type="button" onclick="
                                ...
                                <s:if test='additionalButtonMap.containsKey(#addButton+"divSubmitForm")'>
                                    <button class="btn btn-default pull-right pull-right3" type="button" onclick="divSubmitForm('<s:property value='additionalButtonAction[#addButtonStatus.index]'/>', 'listForm', 'dcSubmitDiv')" name="action:<s:property value='additionalButtonAction[#addButtonStatus.index]'/>" id="<s:property value='additionalButtonAction[#addButtonStatus.index]'/>"><i class="<s:property value='additionalButtonIcon[#addButtonStatus.index]'/>"></i><s:property value='additionalButtonLabel[#addButtonStatus.index]'/></button>
                                </s:if><s:else>
                ...
                <div class="row">
                    ...
                    <div class="col-md-8">
                        ...
                        <s:iterator value="searchFields" var="field" status="rowStatus">
                            ...
                            <s:else>
                                <div class="row">
                                    <div class="col-md-4 rowLabel">${searchFieldsLabel[rowStatus.index]}<s:if test='isRequiredField(#field)'><jsp:include page="/pages/base/requiredField.jsp"/></s:if></div>
                                    <div class="col-md-8">
                                        <s:set var="searchfield_dd_type">${field}_dd_type</s:set>
                                        <s:set var="searchfield_dd_key">${field}_dd_key</s:set>
                                        <s:set var="searchfield_lookupSearch">${field}_lookupSearch</s:set>
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-6">
                                                            <div class="input-group date">
                                                                <s:textfield cssClass="dsrf dateFrom form-control DateRange SameDate" theme="simple" id="search_%{#field.substring(6, (#field.length() - 7))}From" name="search_%{#field.substring(6, (#field.length() - 7))}From" value='%{searchFieldsDateData.get("search_"+extractSearchFieldForDate(#field)+"From")}'/>
                                                        ...
                                                        <div class="col-md-6">
                                                            <div class="input-group date">
                                                                ...
                                                                <s:textfield cssClass="dsrf dateTo form-control DateRange SameDate" theme="simple" id="search_%{#field.substring(6, (#field.length() - 7))}To" name="search_%{#field.substring(6, (#field.length() - 7))}To" value='%{searchFieldsDateData.get("search_"+extractSearchFieldForDate(#field)+"To")}'/>
                                                                <div class="input-group-addon">
                                                                    <i class="fa fa-calendar"></i>
                                                                </div>
                                                            </div>
...
<!--                                                <div class="form-group form-group-default">
                                        ...
                                        <s:elseif test='getSearchFieldLookup().get(#searchfield_lookupSearch) != null'>
                                            <div class="input-group">
                                                <s:textfield theme="simple" cssClass="form-control" id="search_%{#field}" name="search_%{#field}" value='%{searchFieldsDataMap.get("search_"+#field)}' size="30"/>
                        ...
                        <s:iterator value="moreSearchFields" var="field" status="rowStatus">
                                ...
                                <div class="row moreField">
                                    ...
                                    <div class="col-md-8">
                                        ...
                                        <s:elseif test='getSearchFieldDD().get(#searchfield_dd_key) != null'>
                                            ...
                                            <s:else>
                                                <s:if test="getSearchFieldDD().get(#searchfield_dd_list).equalsIgnoreCase('setupcode')">    <%--Added by Delvene @ 29-Aug-2013--%>
                                                    <s:select theme="simple" cssClass="dsrfdd rowText form-control mySelectBox input-sm" name="search_%{#field}" list="getSearchDDList(#searchfield_dd)" listKey="code_id" listValue="code_desc" value='%{searchFieldsDataMap.get("search_"+#field)}' />
                                                </s:if>
                                                <s:else>
                                                    <s:select theme="simple" cssClass="dsrfdd rowText form-control mySelectBox input-sm" name="search_%{#field}" list="getSearchDDList(#searchfield_dd)" listKey="keyData" listValue="valueData" value='%{searchFieldsDataMap.get("search_"+#field)}' />
                                                </s:else>
                                            </s:else>
                                        </s:elseif>
                                        <s:elseif test='getSearchFieldLookup().get(#searchfield_lookupSearch) != null'>
                            ...
                            <s:if test='showPageSize && !(useDataTable)'>
                                <div class="row">
                                    <div class="col-md-4 rowLabel"><s:text name="paging.recordPerPage"/></div>
                                    <div class="col-md-8">
                                        <s:select theme="simple" id="mainPageSize" name="mainPageSize" list="pageSizeOption" listKey="keyData" listValue="valueData" value="%{pageSize}" cssClass="dsrf form-control input-sm sds-dropdown"/>
                                    </div>
                                </div>
                            </s:if>
                    </div>
                    <!--right box-->
                    <div class="col-md-4 text-right">
                        <button class="btn btn-primary" type="submit" onclick="getPageSize('', this.form); return submitSearch('search2DynamicFormId', 'search2Dynamic');"><i class="fa fa-search"></i>&nbsp;<s:text name="button.search"/></button>
                        <button class="btn btn-default reset" type="button" onclick="resetFields(this.form)"><i class="fa fa-undo"></i>&nbsp;<s:text name="button.reset"/></button>
                        <s:if test="has_right('dynamicSearchRpt')">
                            <div class="btn-group">
            ...
            <form action="dynamicAction" method="POST" id="listForm">
                <s:iterator value="searchFields" var="field" status="rowStatus">
                    <s:if test='#field.startsWith("abp_")'>
                        <s:hidden theme="simple" name="search_%{#field}" id="lf_search_%{#field}"/>
                    </s:if>
                </s:iterator>
