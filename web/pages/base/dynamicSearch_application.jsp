                    ...
                    <div class="row pb-3">
                        ...
                        <div class="col-md-8">
                            <div class="ttt">
                                ...
                                <s:hidden theme="simple" name="dynamicSortOrder" value="%{dynamicSortOrder}" escapeJavaScript="true" />
                                <div class="row mb-1">
                                    <label class="col-md-4 col-form-label col-form-label-sm"><s:text name="utimaps.appSearch.case_no" /></label>
                                    <div class="col-md-8">
                                        <div id="survey_job">
                                            <div class="row">
                                               
                                                <div class="col-md-2 p-0 text-middle">
                                                    <label class="col-form-label">UAP</label>
                                                </div>
                                                <div class="col-md-1 p-0 text-middle">
                                                    <label class="col-form-label"> / </label>
                                                </div>
                                                <div class="col-md-4 p-0"><input type="text" id="search_cs_case_seq" maxlength='6' class="rowText form-control form-control-sm" name="search_cs_case_seq" placeholder="Sequence" value="<s:property value='%{searchFieldsDataMap.get("search_cs_case_seq")}'/>" /></div>    
                                                <div class="col-md-1">
                                                    <label class="col-form-label"> / </label>
                                                </div>
                                                <div class="col-md-4 p-0"><input type="text" id="search_cs_case_year" maxlength='4' class="rowText form-control form-control-sm" name="search_cs_case_year" placeholder="Year" value="<s:property value='%{searchFieldsDataMap.get("search_cs_case_year")}'/>" /></div>    
                                            </div>
                                        </div>
