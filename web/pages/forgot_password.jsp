        ...
        <table >
                ...
                <td> 
                    <table cellpadding="3" cellspacing="0" width="100%" >
                        <tr class="supportTitle">
                            <td width="600px">Lupa Kata Laluan </td>
                            <td id='papar' >
            ...
            <tr class="content_info xbox">
                <td>
                    ...
                    <form id="activateForm" action="processCheckForgotPassLoginESS">    
                    <table>
                        <tr><td >Sila masukkan No. Kad Pengenalan/ No. Pasport(bukan warganegara) anda</td></tr>
                    ...
                    <tr><td ><img border="0" class="captcha" src="<s:text name="domain.textualFull"/>/generateCaptchaLoginESS"></td></tr>
                        ...
                        <tr><td>   
                            <s:submit name="loginBtn" id="loginBtn" type="submit" theme="simple" value="%{getText('button.submit')}" src='%{#loginBtn}' action="processCheckForgotPassLoginESS"/>
