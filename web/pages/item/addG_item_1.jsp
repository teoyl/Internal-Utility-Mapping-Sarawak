	...
	<form action="processInsertModule">
            ...
            <div class="xbox">
                ...
                <table cellspacing="0" cellpadding="2" border="0" width="100%" class="form">
                    <tr>
                        <td align="right">
                            <s:submit type="button" cssClass="defaultButton" theme="simple" action="processInsertGitem" value="Save" onclick="return localValidateForm(this.form, 'insert')"/>
                            <s:submit type="button" cssClass="defaultButton" theme="simple" action="cancelGitem" value="Cancel"/>
                        </td>
                    </tr>
                </table>
                <table>
