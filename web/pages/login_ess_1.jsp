        ...
        <div class="login-wrapper ">
            ...
            <div class="login-container bg-white">
                <div class="m-l-30 m-r-30 p-t-35 m-t-10 sm-p-l-15 sm-p-r-15 sm-p-t-40">
                    ...
                    <form id="loginForm" class="p-t-15" role="form" action="processloginLoginEQP" method="post" onsubmit="return false;">    
                        ...
                        <div class="form-group form-group-default ic-row">
                            ...
                            <div class="controls">
                                <input type="text" name="userIcNo" id="userIcNo" placeholder="000000-00-0000" class="form-control ic"  onkeyup= "chkHyphen(this, [6, 9]);" onkeypress="return FilterChar3(this);">
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-md-12 d-flex text-right">
                                <a href="recoverPasswordLoginQP" class="text-info small">Forgot Password ?</a>
                            </div>
                        </div><br>
<!--                        <div class="row">
                        ...
                        <div class="row">
                            <div class="col-md-12 d-flex align-items-center justify-content-end">
                                Not yet registered ? <a href="selectTypeRegistration" class="text-info small">Register</a> here.
                            </div>
                        </div><br>
                        <div class="row">
                            <div class="col-md-12">
                    ...
                    <div class="pull-bottom sm-pull-bottom">
                        <div class="m-b-30 p-r-80 sm-m-t-20 sm-p-r-15 sm-p-b-20 clearfix hidden-xs">
