                    ...
                    <div class="row form-horizontal form-group">
                        ...
                        <div class="col-md-5" style="height: 28px">
                            <s:if test="@com.sains.common.util.SystemConstants@ENV == 0">
                                <input class="relogin" type="text" name="userId" id="userId" value="admin">
                            </s:if><s:else>
                                <input class="relogin" type="text" name="userId" id="userId" value="">
                            </s:else>
                        </div>
                    </div>
                    <div class="row form-horizontal form-group">
                        ...
                        <div class="col-md-5" style="height: 28px">
                            <s:if test="@com.sains.common.util.SystemConstants@ENV == 0">
                                <input class="relogin" type="password" id="passwd" name="passwd" value="password" autocomplete="off" maxlength="20">
                            </s:if><s:else>
                                <input class="relogin" type="password" id="passwd" name="passwd" value="" autocomplete="off" maxlength="20" class="form-control">
                            </s:else>
                        </div>
                    </div>
                    <div class="row form-horizontal form-group">
                        ...
                        <div class="col-md-5">
                            <s:submit cssClass="defaultButton relogin" theme="simple" value='%{getText("button.login")}' action="processloginLogin" onclick="doLogin(); return false;"/>
