...
<div class="dataTables_paginate paging_simple_numbers" id="actions-box">  
        <ul class="pagination">
            <s:set var="pageItem" value="pagingItem" />
            <s:set var="firstPage" value="pagingItem.get('First')"/>
            <s:set var="previousPage" value="pagingItem.get('Previous')"/>
            ...
            <s:if test='#firstPage != null'>
                <li>
                    <a id="fpId" href='#' onclick="gotoPage('<s:property value="%{#firstPage}"/>')"><s:text name="paging.first"/></a>
                </li>
            </s:if>
            <s:if test='#previousPage != null'>
                <li>
                    <a id="ppId" href='#' onclick="gotoPage('<s:property value="%{#previousPage}"/>')" aria-label="Previous"><s:text name="paging.previous"/></a>
                </li>
            </s:if>
            <s:iterator value='#pageItem.get("items")' var="item">
                <s:if test="#item == pageNo">
                    ...
                    <s:if test="#item != pageNo">
                    <li><a href='#' onclick="gotoPage('<s:property escapeJavaScript="true" value="%{item}"/>')"><s:property escapeJavaScript="true" value="%{item}"/></a></li>
                    </s:if>
                </s:iterator>
                <s:if test='#nextPage != null'>
                <li>
                    <a id="npId" href='#' onclick="gotoPage('<s:property value="%{#nextPage}"/>')" aria-label="Next"><s:text name="paging.next"/></a>
                </li>
            </s:if>
            <s:if test='#lastPage != null'>
                <li>
                    <a id="lpId" href='#' onclick="gotoPage('<s:property value="%{#lastPage}"/>')"><s:text name="paging.last"/>
                    </a>
                </li>
            </s:if>
        </ul>     
