...
<div class="row">
    <div class="col-xs-8 col-sm-7 col-md-6 col-lg-6" id="actions-box">  
        <ul class="pagination">
            ...
            <s:if test='#firstPage != null'>
                <li>
                    <a id="fpId" href='#' onclick="gotoPage('<s:property escapeJavaScript="true" value="%{pagingURL}"/>&pageNo=<s:property escapeJavaScript="true" value="%{firstPage}"/>&action=<s:property escapeJavaScript="true" value="%{action}"/>')"><s:text name="paging.first"/></a>
                </li>
            </s:if>
            <s:if test='#previousPage != null'>
                <li>
                    <a id="ppId" href='#' onclick="gotoPage('<s:property escapeJavaScript="true" value="%{pagingURL}"/>&pageNo=<s:property escapeJavaScript="true" value="%{previousPage}"/>&action=<s:property escapeJavaScript="true" value="%{action}"/>')" aria-label="Previous"><s:text name="paging.previous"/></a>
                </li>
            </s:if>
            <s:iterator value='#pageItem.get("items")' var="item">
                <s:if test="#item == pageNo">
                    <li class="active"><a href="#"><s:property escapeJavaScript="true" value="%{item}"/></a></li>
                    </s:if>
                    <s:if test="#item != pageNo">
                    <li><a href='#' onclick="gotoPage('<s:property escapeJavaScript="true" value="%{pagingURL}"/>&pageNo=<s:property escapeJavaScript="true" value="%{item}"/>&action=<s:property escapeJavaScript="true" value="%{action}"/>')"><s:property escapeJavaScript="true" value="%{item}"/></a></li>
                    </s:if>
                ...
                <li>
                    <a id="npId" href='#' onclick="gotoPage('<s:property escapeJavaScript="true" value="%{pagingURL}"/>&pageNo=<s:property escapeJavaScript="true" value="%{nextPage}"/>&action=<s:property escapeJavaScript="true" value="%{action}"/>')" aria-label="Next"><s:text name="paging.next"/></a>
                </li>
            </s:if>
            <s:if test='#lastPage != null'>
                <li>
                    <a id="lpId" href='#' onclick="gotoPage('<s:property escapeJavaScript="true" value="%{pagingURL}"/>&pageNo=<s:property escapeJavaScript="true" value="%{lastPage}"/>&action=<s:property escapeJavaScript="true" value="%{action}"/>')"><s:text name="paging.last"/>
                    </a>
                </li>
            </s:if>
        </ul>     
    ...
    <div class="col-xs-4 col-sm-5 col-md-6 col-lg-6 text-right">
        <s:if test="(pageNo * pageSize) >= numberOfRows">
            <s:if test="(pageNo - 1) * pageSize + 1 == numberOfRows">
                <s:text name="paging.record2">
                    <s:param value="numberOfRows" />
