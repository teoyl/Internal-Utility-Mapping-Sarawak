<%-- 
    ...
    Created on : Aug 27, 2010, 5:33:07 PM
    Author     : Ivy Lee
--%>
...
<head>
    ...
    <script type="text/javascript">
        ...
        function required(){
            this.aa = new Array("us_original_password", "<s:text name='user.currentPassword' />")
            this.ab = new Array("us_password", "<s:text name='user.newPassword' />")
            this.ac = new Array("confirmPassword", "<s:text name='user.confirmPassword' />")
    </script>
                      ...
                      <table width="85%" border="0" cellspacing="0" cellpadding="2" align="center">  <%--form table--%>
                        ...
                        <tr>
                            ...
                            <td width="100%" align='left' height="60" valign="top">
                                 <p><b><span style='color:maroon'>Note : </span> To reset your password, provide your current password and and enter your new password below.</b></p>
                            </td>
                        </tr>
                        <tr>
                             <td align='center'valign="top" colspan="2">
                                 <table width="90%" border="0">
                                        <tr>
                                            <td <%--height="20px"--%>>
                                                <%--<div align="left" ><s:text name="user.id"/></div>--%>
                                            </td>
                                            <td><div align="left" >
                                                 <%--<b><s:property value="model.us_id"/></b>--%>
                                        ...
                                        <%--<tr>
                                         ...
                                         <tr>
                                            <td><div align="left"><s:text name="user.currentPassword"/><jsp:include page="/pages/base/requiredField.jsp"/></div></td>
                                            <td><div align="left">
                                                <s:password cssClass="field" theme="simple" name="us_original_password" value="%{us_original_password}" size="50"/>
                                                </div>
                                            </td>
                                        </tr>
                                       <tr>
