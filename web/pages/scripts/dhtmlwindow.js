...
// v1.04: 06/03/2008 Added attribute to allow user to show minimize button or not
// -------------------------------------------------------------------

var dhtmlwindow={
imagefiles:['images/popup2_min.gif', 'images/popup2_close.gif', 'images/popup2_restore.gif', 'images/popup2_resize.gif'], //Path to 4 images used by script, in that order
...
function close(t)
{
  document.getElementById(t+'dwin').hide();
}
