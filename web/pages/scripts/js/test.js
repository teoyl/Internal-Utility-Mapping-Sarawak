...
var a = document.getElementById("fonts"); 
var fontSize = a.options[a.selectedIndex].value;
var setFontSize = "2";
...
//alert("a="+points+", b="+cornerThres+", c="+match)
...
fontSize = a.options[a.selectedIndex].value;
if(fontSize == "0"){
    setFontSize = "0"
}
else if(fontSize == "1"){
