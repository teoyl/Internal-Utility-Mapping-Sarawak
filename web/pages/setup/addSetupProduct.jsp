<%-- 
    Document   : addSetupProduct
    Created on : Jul 1, 2010, 3:55:39 PM
    Author     : iveon
--%>
...
<body>
    ...
    <form theme="simple" action="processInsertSetupProduct">
        ...
        <div class="xbox">
            <table cellspacing="0" cellpadding="2" border="0" width="100%" class="form">
                <tr>
                    <td align="right">
                        <s:submit type="button" cssClass="defaultButton" theme="simple" action="processInsertSetupProduct" value="Save" onclick="return localValidateForm(this.form, 'insert')"/>
            ...
            <table>
                ...
                <tr>
                    ...
                    <td width="3px">:</td>
                    <td align="left"><s:textfield theme="simple" name="product_code"  /> (e.g. MAP001)</td>
                </tr>
                 <tr>
                    <td width="20px">&nbsp;</td>
                ...
                <tr>
                    ...
                    <td width="3px">:</td>
                    <td align="left"><s:textfield theme="simple" size="100%" name="product_name" /></td>
                </tr>
                <tr>
                    <td width="20px">&nbsp;</td>
                    <td width="150px" align=left><s:text name="product.shortName"/></td>
                    <td width="3px">:</td>
                    <td align="left"><s:textfield theme="simple" size="100%" name="product_short_name" /></td>
                </tr>
                <tr>
                    <td width="20px">&nbsp;</td>
                    <td width="150px" align=left><s:text name="product.desc"/></td>
                    <td width="3px">:</td>
                    <td align="left"><s:textarea cssClass="textArea" theme="simple" cols="50"  rows="3" name="product_desc" /></td>
                </tr>
                <tr>
                    <td width="20px">&nbsp;</td>
                    <td width="150px" align=left><s:text name="product.responseTime"/></td>
                    <td width="3px">:</td>
                    <td align="left"><s:textfield theme="simple" name="product_response_time" /></td>
                </tr>
                <tr>
                    <td width="20px">&nbsp;</td>
                    <td width="150px" align=left><s:text name="product.remark"/></td>
                    <td width="3px">:</td>
                    <td align="left" ><s:textarea cssClass="textArea" theme="simple" cols="50"  rows="3"  name="product_remark" />
                </tr>
                <tr>
                    <td width="20px">&nbsp;</td>
                ...
                <tr>
                    ...
                    <td width="3px">:</td>
                    <td align="left">
                        <input type="text" name="product_rvrcode" value="${product_rvrcode}" readonly/>
                        <script language="javascript">
                            lookup("Search Revenue Code", "Rvrcode", "trancode,description,description", "product_rvrcode,description,lbdescription",
                ...
                <tr>
                    ...
                    <td width="3px">:</td>
                    <td align="left"><s:textfield theme="simple" name="product_unit_cost" /></td>
                </tr>
                  <tr>
                    <td width="20px">&nbsp;</td>
                ...
                <tr>
                 ...
                 <%--<tr>--%>
                    <%--<td width="20px">&nbsp;</td>
                    <td width="150px" align=left><s:text name="product.approvalAuthority"/>
                ...
                <tr>
                    ...
                    <td align="left">
                        ...
                        <script language="javascript">
                            ...
                            "useSetup_SetupProduct",  "product_code,product_name", "", "");
                        </script>
                    </td>
                </tr>
                <tr>
                    ...
                    <td width="3px">:</td>
                    <td align="left"><s:textfield theme="simple" size="100%" name="product_ref_link" /></td>
                </tr>
                <tr>
                    <td width="20px">&nbsp;</td>
                    <td width="150px" align=left><s:text name="product.sampleLink"/></td>
                    <td width="3px">:</td>
                    <td align="left"><s:textfield theme="simple" size="100%" name="product_sample_link" /></td>
                </tr>
