...
//            }
    ...
    <body>
        ...
        <form method="post" name="form" id="form" action="processUpdateSetupAddress">
            ...
            <div class="row">
                <div class="col-md-12 text-right">
                    <button class="btn btn-primary" type="submit" name="action:processUpdateSetupAddress" id="processUpdateSetupAddress" onclick="return localValidateForm(this.form, 'insert')"><i class="fa fa-save"></i>Save</button>        
