        ...
        <form method="post" id="addApplicationFormId" action="processInsertApplication">
            ...
            <div class="panel panel-default">
                <div class="panel-heading">
                    <h4><s:text name="application"/>&nbsp;<small><s:text name="button.add"/></small></h4>
                </div>
            ...
            <div class="row">
                <div class="col-md-12 text-right">
                    <button class="btn btn-primary" type="submit" name="action:processInsertApplication" id="processInsertApplication" onclick="return localValidateForm(this.form, 'insert')"><i class="fa fa-save"></i><s:text name="button.save"/></button>        
                    ...
                    <%--s:submit type="submit" cssClass="defaultButton dynamic-pull mrg-lr-5" theme="simple" action="processInsertApplication" value="Save" onclick="return localValidateForm(this.form, 'insert')"/>
