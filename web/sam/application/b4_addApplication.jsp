                ...
                <div class="kt-portlet__head">
                    <div class="kt-portlet__head-label">
                        <h3 class="kt-portlet__head-title">
                            <s:text name="application"/>&nbsp;<small><s:text name="button.add"/></small>
                        </h3>
                    </div>
                </div>
                ...
                <div class="kt-form__actions">
                    <div class="row">
                        <div class="col-md-12 text-right">
                            <button class="btn btn-brand" type="submit" name="action:processInsertApplication" id="processInsertApplication" onclick="return localValidateForm(this.form, 'insert')"><i class="fa fa-save"></i><s:text name="button.save"/></button>        
