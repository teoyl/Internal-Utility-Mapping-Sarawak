        ...
        <form method="post" id="addApplicationFormId" action="processUpdateApplication">
            ...
            <div class="card">
                <div class="card-header bg-light">
                    <h5><s:text name="application"/>&nbsp;<small class="fw-normal text-600"><s:text name="button.edit"/></small></h5>
                </div>
                <div class="card-body">
                    <div class="row mb-1">
                        <label class="col-md-4 col-form-label col-form-label-sm"><s:text name="application.type"/><font class="asterisk">*</font></label>
                        <div class="col-md-5">
                            <s:select theme="simple" name="application_type" list="applicationTypeOption" listKey="keyData" listValue="valueData" onchange="typeChanged(this)" cssClass="rowText form-control sds-dropdown mySelectBox form-control-sm required"/>
                        </div>
                    </div>
                    <div class="row mb-1">
                        <label class="col-md-4 col-form-label col-form-label-sm"><s:text name="application.code"/><font class="asterisk">*</font></label>
                        <div class="col-md-5">
                            <s:textfield theme="simple" name="application_code" value="%{model.application_code}" cssClass="form-control form-control-sm required" maxlength='%{model.columnLengthMap["application_code"]}'/>
                        </div>
                    </div>
                    <div class="row mb-1">
                    ...
                    <div class="row mb-1">
                        ...
                        <div class="col-md-5">
                            <s:textfield theme="simple" name="application_order" value="%{model.application_order}" cssClass="form-control form-control-sm" />
                        </div>
                    </div>
                    <div class="row mb-1">
                    ...
                    <div class="row mb-1">
                        ...
                        <div class="col-md-5">
                            <s:textfield theme="simple" name="remark" value="%{model.remark}" cssClass="form-control form-control-sm"/>
                        </div>
                    </div>
                    <div class="row mb-1">
                                            ...
                                            <tr>
                                                <th style="width:1%;" class="white-space-nowrap">
                                                    <div class="form-check fs-0 d-flex align-items-center">
                                                        <s:if test="model.rightsList.size() > 0">
                                                            <input type="checkbox" type="checkbox"  id="rights_select" class="selectAll form-check-input" name="rights_select" onClick="toggleCheckboxByName(this,'rights_selected');">
                                                            <!--<input type="checkbox" id="rights_select" name="rights_select" onclick="toggleCheckbox(this, delRights_ids);">-->
                                                        </s:if>
                                                        <s:else>
                                                            <input type="checkbox" type="checkbox" id="rights_select" class="selectAll form-check-input" name="rights_select" disabled >
                                                        </s:else>
                                                ...
                                                <tr class="<s:if test="#rightsStatus.odd == true ">odd</s:if><s:else>even</s:else>">
                                                    <td class="white-space-nowrap">
                                                        ...
                                                        <div class="form-check fs-0 mb-0 d-flex align-items-center">
                                                            <input type="checkbox" type="checkbox" name="rights_selected" class="checkbox_child form-check-input" id="_${rightsStatus.index}" value="${rightsStatus.index}" onclick="toggleSelectAll()">
                    ...
                    <div class="row">
                        <div class="col text-end">
                            <button class="btn btn-primary" type="submit" name="action:processUpdateApplication" id="processUpdateApplication" onclick="return localValidateForm(this.form, 'insert')"><i class="far fa-save"></i><span class="ms-2"><s:text name="button.save"/></span></button>        
                            <button class="btn btn-falcon-default" type="submit" name="action:cancelApplication" id="cancelApplication"><i class="fas fa-times"></i><span class="ms-2"><s:text name="button.cancel"/></span></button>        
                        </div>
                    </div>
                </div>
        </form>
        <div id="iconLoader" class="d-none"/>
    </body>
</html>