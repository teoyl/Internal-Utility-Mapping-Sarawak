        ...
        <form method="post" id="addApplicationFormId" action="processUpdateApplication">
            ...
            <div class="panel panel-default">
                <div class="panel-heading">
                    <h4><s:text name="application"/>&nbsp;<small><s:text name="button.edit"/></small></h4>
                </div>
                <div class="panel-body">
                    <div class="form-group">
                        <label class="col-md-4 control-label"><s:text name="application.type"/><font class="asterisk">*</font></label>
                        <div class="col-md-5">
                    ...
                    <div class="form-group">
                        <label class="col-md-4 control-label"><s:text name="application.code"/><font class="asterisk">*</font></label>
                        <div class="col-md-5">
                            <s:textfield theme="simple" name="application_code" value="%{model.application_code}" cssClass="form-control required" maxlength='%{model.columnLengthMap["application_code"]}'/>
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="col-md-4 control-label"><s:text name="application.name"/><font class="asterisk">*</font></label>
                        <div class="col-md-5">
                            <s:textfield theme="simple" name="application_name" value="%{model.application_name}" cssClass="form-control"/>
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="col-md-4 control-label"><s:text name="application.nameCode"/></label>
                        <div class="col-md-5">
                            <s:textfield theme="simple" name="application_name_code" value="%{model.application_name_code}" cssClass="form-control"/>
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="col-md-4 control-label"><s:text name="application.icon"/></label>
                        <div class="col-md-5">
                    ...
                    <div class="form-group">
                        <label class="col-md-4 control-label"><s:text name="application.actionName"/><font class="asterisk">*</font></label>
                        <div class="col-md-5">
                            <s:textfield theme="simple" name="action_name" value="%{model.action_name}" cssClass="form-control required"/>
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="col-md-4 control-label"><s:text name="application.actionClass"/><font class="asterisk">*</font></label>
                        <div class="col-md-5">
                            <s:textfield theme="simple" name="action_class" value="%{model.action_class}" cssClass="form-control" />
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="col-md-4 control-label"><s:text name="application.systemType"/><font class="asterisk">*</font></label>
                        <div class="col-md-5">
                    ...
                    <div class="form-group">
                        <label class="col-md-4 control-label"><s:text name="application.order"/><font class="asterisk">*</font></label>
                        <div class="col-md-5">
                            <s:textfield theme="simple" name="application_order" value="%{model.application_order}" cssClass="form-control" />
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="col-md-4 control-label"><s:text name="application.attachedTo"/><font class="asterisk">*</font></label>
                        <div class="col-md-5">
                            <div class="input-group">
                                ...
                                <span class="input-group-addon" onclick="lookupModal($('#module_code'), 'modalLookup?lookFor=module_code,module_id,module_name&writeTo=module_code,attached_module_id,module_desc&lookup=useSetup_Module&displayedColumns=module_code,module_name','','postModule')"><i class="fa fa-search"></i></span>
                            </div>
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="col-md-4 control-label"><s:text name="common.remarks"/></label>
                        <div class="col-md-5">
                            <s:textfield theme="simple" name="remark" value="%{model.remark}" cssClass="form-control"/>
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="col-md-4 control-label">Application Rights</label>
                        <div class="col-md-5">
                            <!--<label>Application Rights</label><br>-->
                            <div class="radio-group radio-group-default entryCb" style="margin-top: 5px;  margin-bottom:10px;">
                                <div class="col-md-6 checkbox check-success" style="margin-top: -5px;">
                                    ...
                                    <div class="col-lg-6 checkbox check-success">
                                    ...
                                    <div class="col-lg-6 checkbox check-success" style="margin-bottom:4px;">
            ...
            <div class="row">
                <div class="col-md-12">
                    <h3 class="title-v3"><s:text name="application.additionalRights" /></h3>
                </div>
            </div>
            <div class="row">
                <div class="col-md-12 form-row-margin">
                    <s:if test="has_right('processAddRights')">
                        <button class="btn btn-default" type="submit" name="action:processAddRightsApplication" id="processAddRightsApplication"><i class="fa fa-plus"></i>Add Rights</button>
                    </s:if>
                    <s:if test="has_right('processDeleteRights')">
                        <button class="btn btn-default" type="submit" name="action:processDeleteRightsApplication" id="processDeleteRightsApplication" onclick="if (isCheckboxSelected(form.rights_selected)) {
            ...
            <div class="row">
                <div class="col-md-12 text-right">
                    <button class="btn btn-primary" type="submit" name="action:processUpdateApplication" id="processUpdateApplication" onclick="return localValidateForm(this.form, 'insert')"><i class="fa fa-save"></i><s:text name="button.save"/></button>        
                    <button class="btn btn-default" type="submit" name="action:cancelApplication" id="cancelApplication"><i class="fa fa-close"></i><s:text name="button.cancel"/></button>        
                </div>
            </div>
        </form>
