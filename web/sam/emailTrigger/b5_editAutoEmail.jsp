        ...
        <form theme="simple" action="processUpdateAutoEmail">
            ...
            <div class="card">
                <div class="card-header bg-light">
                    <h5><s:text name="autoEmailSetup.title"/> <small class="fw-normal text-600"><s:text name="button.edit"/></small></h5>
                </div>
                <div class="card-body">
                    <div class="row">
                        <!--left box-->
                        ...
                        <div class="col-md-3 text-end">
                            <button class="btn btn-primary btn-sm mb-1" type="submit" name="action:processUpdateAutoEmail" id="processUpdateAutoEmail" onclick="return localValidateForm(this.form, 'update')"><i class="fa fa-save"></i><span class="ms-1">Save</span></button>     
                                                ...
                                                <tr class="<s:if test="#paramStatus.odd == true ">odd</s:if><s:else>even</s:else>">
                                                    <td class="align-middle white-space-nowrap">
                                                        ...
                                                        <div class="form-check fs-0 d-flex align-items-center">
                                                            ...
                                                            <label for="${paramStatus.index}" class="tableFormCheckbox form-check-label"></label>
                                                        </div>
