...
<html>
    ...
    <body>
        ...
        <%--div class="row">
            <div class="col-md-4">
                <h3 class="title-v3"><s:text name="autoEmailSetup.title" /> <small><s:text name="actionType.edit" /></small></h3>
            </div>
        </div--%>

        <form theme="simple" action="processUpdateAutoEmail">
            <s:hidden theme="simple" name="action" />
            <s:hidden name="auto_email_id" value="%{model.auto_email_id}"/>
            ...
            <div class="row">
                ...
                <div class="col-md-3 text-right">
                    <button class="btn btn-primary" type="submit" name="action:processUpdateAutoEmail" id="processUpdateAutoEmail" onclick="return localValidateForm(this.form, 'update')"><i class="fa fa-save"></i>Save</button>     
                    ...
                    <%--s:submit type="submit" cssClass="defaultButton dynamic-pull btn mrg-lr-5" theme="simple" action="processUpdateAutoEmail" value="Save" onclick="return localValidateForm(this.form, 'update')"/>
            ...
            <%--div class="panel panel-default ">
                ...
                <div class="panel-body">
                    ...
                    <table class="table borderless">
                        ...
                        <tr>
                            <td width="20px">&nbsp;</td>
                            <td width="150px" align=left><s:text name="autoEmailSetup.notification"/><jsp:include page="/pages/base/requiredField.jsp"/></td>
                            <td>:</td>
                            <td><div class="input-group">
                                    <s:hidden theme="simple" name="no_id" value="%{model.no_id}"/>
                                    <input type="text" name="notification_code" value="${notification_code}" class="input-md form-control" readonly/>
                    ...
                    <table class="defaultTable table borderless" cellspacing="1" cellpadding="1"  width="100%">
                        ...
                        <s:iterator value="emailParamList" status="paramStatus" id="paramAutoEmail">
                            <tr class="<s:if test="#paramStatus.odd == true ">odd</s:if><s:else>even</s:else>">
                                ...
                                <td width="460"><s:textfield size="50" theme="simple" name="retrieve_from" value="%{#paramAutoEmail.retrieve_from}"/></td>
                            </tr>
                        </s:iterator>
                    </table>
                </div>
