...
<body>
	...
	<form action="insertMenu" name="menuForm">
		...
		<table>
			<tr>
				<td align="right"><s:text name="menu.code"/>:</td><td><s:textfield theme="simple" name="menu_code"/></td>
			</tr>
			<tr>
				<td align="right"><s:text name="menu.name"/>:</td><td><s:textfield theme="simple" name="menu_name"/></td>
			</tr>
			<tr>
				<td colspan="2">
