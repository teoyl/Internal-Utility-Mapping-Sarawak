...
<!--        <script type="text/javascript" src="include/dhtmlwindow/windowfiles/dhtmlwindow.js"></script>
    ...
    <body>
        ...
        <form id="moduleFormId" action="processInsertModule" method="post">
            <s:hidden name="action" />
            <s:hidden name="antiCsrf" value="%{#session.antiCsrf}"/>
            <div class="panel panel-default">
                <div class="panel-heading">
                    <h4><s:text name="module"/>&nbsp;<small><s:text name="button.add"/></small></h4>
                </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-5">
                            ...
                            <div class="input-group">
                                ...
                                <span class="input-group-addon" onclick="if (valcheckType()) {lookupModal($('#module_code'), 'modalLookup?lookFor=module_id,module_code&writeTo=parent_module_id,parent_code&lookup=useSetup_Module&displayedColumns=module_code,module_name')}"><i class="fa fa-search"></i></span>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="row">
                <div class="col-md-12 text-right">
                    <button class="btn btn-primary" type="submit" name="action:processInsertModule" id="processInsertModule" onclick="return localValidateForm(this.form, 'insert')"><i class="fa fa-save"></i><s:text name="button.save"/></button>        
