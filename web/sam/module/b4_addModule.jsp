                ...
                <div class="kt-portlet__head">
                    <div class="kt-portlet__head-label">
                        <h3 class="kt-portlet__head-title">
                            <s:text name="module"/>&nbsp;<small><s:text name="button.add"/></small>
                        </h3>         
                    </div>
                </div>
                    ...
                    <div class="kt-form__actions">
                        <div class="row">
                            <div class="col-md-12 text-right">
                                <button class="btn btn-brand" type="submit" name="action:processInsertModule" id="processInsertModule" onclick="return localValidateForm(this.form, 'insert')"><i class="fa fa-save"></i>Save</button>        
                                ...
                                <%--s:submit type="button" cssClass="defaultButton dynamic-pull btn mrg-lr-5" theme="simple" action="processInsertModule" value="Save" onclick="return localValidateForm(this.form, 'insert')"/>
