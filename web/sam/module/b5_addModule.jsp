        ...
        <form id="moduleFormId" action="processInsertModule" method="post">
            ...
            <div class="card">
                <div class="card-header bg-light">
                    <h5><s:text name="module"/>&nbsp;<small class="fw-normal text-600"><s:text name="button.add"/></small></h5>
                </div>
                <div class="card-body">
                    <div class="row mb-1">
                    ...
                    <div class="row mt-3">
                        <div class="col text-end">
                            <button class="btn btn-sm btn-primary" type="submit" name="action:processInsertModule" id="processInsertModule" onclick="return localValidateForm(this.form, 'insert')"><i class="fa fa-save"></i><span class="ms-1"><s:text name="button.save"/></span></button>        
