        ...
        <SCRIPT language="javascript">
            ...
            function localValidateForm(form, operation) {
                ...
                if (errors.length > 0) {
                    ...
                    reloadOnClose = true;
                    divSubmitForm("processUpdateModule", "moduleFormId", "moreInfoDiv");
                }
                return false;
//                return errors.length > 0 ? false : true;
    ...
    <body>
        ...
        <form id="moduleFormId" action="processUpdateModule" method="post">
            ...
            <s:hidden name="moreInfoUpdate" value="Y" />
                ...
                <div class="panel-body">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-5">
                            ...
                            <div class="input-group">
                                <s:textfield id="parent_code" name="model.parentModule.module_code" value="%{model.parentModule.module_code}" readonly="true" cssClass="form-control" required=""/>
                                <span class="input-group-addon" onclick="if (valcheckType()) {lookupModal($('#moduleFormId').find('#module_code'), 'modalLookup?lookFor=module_id,module_code&writeTo=parent_module_id,parent_code&lookup=useSetup_Module&displayedColumns=module_code,module_name')}"><i class="fa fa-search"></i></span>
                            </div>
                        </div>
                    </div>
                </div>
