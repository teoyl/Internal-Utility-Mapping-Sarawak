                                    ...
                                    <s:if test='#paramItem.field_indicator.equals("input")'>
                                        <s:if test='#paramItem.paramType.equalsIgnoreCase("select")'>
                                            <div class="form-group row">
                                                <label class="col-md-4 col-form-label sub"><s:property value="#paramItem.parameter_descs"/><s:if test='#paramItem.field_indicator.equalsIgnoreCase("input") && #paramItem.req_field.equalsIgnoreCase("Y")'><jsp:include page="/pages/base/requiredField.jsp"/></s:if></label>
                                                <div class="col-md-6">
                    ...
                    <div class="kt-form__actions">
                        <div class="row form-row-margin">
                            <div class="col-md-12 text-right login">
                                <s:submit type="button" cssClass="btn btn-outline-brand" theme="simple" action="loadAddPageParameter" value="Copy This Parameter"/>
                                <s:submit type="button" cssClass="btn btn-brand" theme="simple" action="processUpdateParameter" value="Save" onclick="return localValidateForm(this.form);"/>
