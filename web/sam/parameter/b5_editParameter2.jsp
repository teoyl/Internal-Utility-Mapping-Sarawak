                ...
                <div class="card-body">
                    ...
                    <div class="row">
                        <div class="col text-end">
                            <s:submit type="button" cssClass="btn btn-sm btn-falcon-default" theme="simple" action="loadAddPageParameter" value="Copy This Parameter"/>
                            <s:submit type="button" cssClass="btn btn-sm btn-primary" theme="simple" action="processUpdateParameter" value="Save" onclick="return localValidateForm(this.form);"/>
