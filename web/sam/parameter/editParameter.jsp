...
<title><s:text name="system.name"/> - <s:text name="Param.applicationName" /> - <s:property value="%{modelList[0].system_descs}" /></title>
<s:head />
</head>
<body>
	...
	<form action="processUpdateParameter" id="processUpdateParameterFormId" method="post">
            ...
            <div class="xbox">
                <table cellspacing="0" cellpadding="2" border="0" width="100%" class="form">
                    <tr>
                        <td align="right">
                            <s:submit type="button" cssClass="defaultButton" theme="simple" action="loadAddPageParameter" value="Copy This Parameter"/>
                            <s:submit type="button" cssClass="defaultButton" theme="simple" action="processUpdateParameter" value="Save" onclick="return localValidateForm(this.form);"/>
                            <s:submit type="button" cssClass="defaultButton" theme="simple" action="cancelParameter" value="Cancel"/>
                        </td>
                    </tr>
                </table>
