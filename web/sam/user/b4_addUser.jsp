        ...
        <form theme="simple" action="processInsertUser" class="prForm" method="post">
            ...
            <div class=" kt-portlet">
                <div class="kt-portlet__head">
                    <div class="kt-portlet__head-label">
                        <h3 class="kt-portlet__head-title">
                            <s:text name="user"/>&nbsp;<small><s:text name="button.add"/></small>
                        </h3> 
                    </div>
                </div>
                <div class="kt-portlet__body">
                    ...
                    <div class="form-group row">
                        <label class="col-3 col-form-label"><s:text name="user.password"/><font class="asterisk">*</font></label>
                        <div class="col-md-5">
                    ...
                    <div class="kt-form__actions">
                        <div class="row">
                            <div class="col-md-12 text-right">
                                <button class="btn btn-brand" type="submit" name="action:processInsertUser" id="processInsertUser" onclick="return localValidateForm(this.form, 'insert')"><i class="fa fa-save"></i>Save</button>     
