...
<html>
    ...
    <body>
        ...
        <div class="panel panel-default ">  
            <div class="panel-heading"><h4 class="panel-title"><s:text name="actionType.search"/></h4></div>
                ...
                <form action="processSearchUserUserGroup" method="post">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4 text-right">
                            <button class="btn btn-primary" type="submit"><i class="fa fa-search"></i><s:text name="actionType.search"/></button>
                            <s:if test='model.ug_id != ""'>
                                <button class="btn btn-default" type="submit" name="action:addUserEditUserGroup" id="addUserEditUserGroup"><i class="fa fa-close"></i><s:text name="button.cancel"/></button>
                                <%--<s:submit cssClass="defaultButton" theme="simple" action="addUserEditUserGroup" value="Cancel"/>--%>
                            </s:if>
                            <s:else>
                                <button class="btn btn-default" type="submit" name="action:addUserUserGroup" id="addUserUserGroup"><i class="fa fa-close"></i><s:text name="button.cancel"/></button>
            ...
            <form theme="simple" action="${model.ug_id != ''?'addUserEditUserGroup':'addUserUserGroup'}">
                <div class="row form-row-margin">
                    <div class="col-md-12">
                        <s:if test="model.ug_id != ''">
                            <button class="btn btn-default" type="submit" name="action:addUserEditUserGroup" id="addUserEditUserGroup" onclick="return validateSelect(form)" ><i class="fa fa-plus"></i><s:text name="button.add.selected"/></button>
                        ...
                        <s:else>
                            <button class="btn btn-default" type="submit" name="action:addUserUserGroup" id="addUserUserGroup" onclick="return validateSelect(form)" ><i class="fa fa-plus"></i><s:text name="button.add.selected"/></button>
