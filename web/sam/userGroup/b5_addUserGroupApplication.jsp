    ...
    <body>
        ...
        <div class="card">  
            <div class="card-header bg-light">
                <h5><s:text name="actionType.search"/>&nbsp;<s:property value='getDynamicSearchDescription("Application")'/></h5>
            </div>
            <div class="card-body">
                <form theme="simple" action="processSearchApplicationUserGroup" method="post">
                    ...
                    <div class="row mb-1">
                        <div class="col-md-8">
                            <jsp:include page="/pages/base/b5_dynamicSearch2.jsp"/>
                        </div>
                        <div class="col-md-4 text-end">
                            <%--<s:submit cssClass="defaultButton" theme="simple" value="Search"/>--%>
                            <button class="btn btn-sm btn-primary" type="submit"><i class="fa fa-search"></i> <span class="ms-1">Search</span></button>

                            <s:if test='model.ug_id != ""'>
                                <%--<s:submit theme="simple" cssClass="defaultButton" action="addApplicationEditUserGroup" value="Cancel"/>--%>
                                <button class="btn btn-sm btn-falcon-default" type="submit" name="action:addApplicationEditUserGroup" id="addApplicationEditUserGroup"><i class="fa fa-times"></i> <span class="ms-1">Cancel</span></button>

                            </s:if>
                            <s:else>
                                <%--<s:submit theme="simple" cssClass="defaultButton" action="addApplicationUserGroup" value="Cancel"/>--%>
                                <button class="btn btn-sm btn-falcon-default" type="submit" name="action:addApplicationUserGroup" id="addApplicationUserGroup"><i class="fa fa-times"></i> <span class="ms-1">Cancel</span></button>
                ...
                <form theme="simple" action='${model.ug_id != ""?"addApplicationEditUserGroup":"addApplicationUserGroup"}' method="post">
                    ...
                    <div class="row form-row-margin">
                        <div class="col-md-12">
                            <s:if test='model.ug_id != ""'>
                                <button class="btn btn-sm btn-falcon-default" type="submit" name="action:addApplicationEditUserGroup" id="addApplicationEditUserGroup" onclick="return validateSelect(form)" ><i class="fa fa-plus"></i> <span class="ms-1"><s:text name="button.add.selected"/></span></button>
                            ...
                            <s:else>
                                <button class="btn btn-sm btn-falcon-default" type="submit" name="action:addApplicationUserGroup" id="addApplicationUserGroup" onclick="return validateSelect(form)" ><i class="fa fa-plus"></i> <span class="ms-1"><s:text name="button.add.selected"/></span></button>
