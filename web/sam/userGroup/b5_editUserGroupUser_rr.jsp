                ...
                <div class="row">
                    <div class="col-md-8 form-row-margin">
                        <s:if test="has_right('loadAddUserPage')">
                            <button class="btn btn-falcon-default" type="submit" name="action:loadAddUserPageUserGroup" id="loadAddUserPageUserGroup"><i class="fa fa-plus"></i> Add User</button>  
                        ...
                        <s:if test="has_right('processDeleteUser')">
                            <button class="btn btn-falcon-default" type="submit" name="action:processDeleteUserUserGroup" id="processDeleteUserUserGroup"><i class="fa fa-trash-o"></i> Delete User</button>
                    ...
                    <div class="col-md-4 text-end">
                        <button class="btn btn-falcon-primary" type="submit" name="action:processUpdateRRUserGroup" id="processUpdateRRUserGroup" onclick="return validateForm(this.form, 'update')"><i class="fa fa-save"></i> Save</button> 
                        <s:if test='%{action.equals("USJ_RoundRobinSetup")}'>
                            <button class="btn btn-falcon-default" type="submit" name="action:cancelUserGroup" id="goEditPageUserGroup"><i class="fa fa-arrow-left"></i> Back</button>
                        </s:if>
                        <s:else>
                            <button class="btn btn-falcon-default" type="submit" name="action:goEditPageUserGroup" id="goEditPageUserGroup"><i class="fa fa-arrow-left"></i> Back</button>
                        </s:else>
