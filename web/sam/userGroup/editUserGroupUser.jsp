        ...
        <form action="processUpdateUserUserGroup" name="userGroupForm" id="userGroupForm" method="post">
            ...
            <div class="panel panel-default">
                <div class="panel-heading">
                    <h4><s:property value="%{model.group_name}"/> (<s:property value="%{model.group_code}"/>)&nbsp;<small><s:text name="button.search"/></small></h4>
                </div>
                <div class="panel-body">
                    <div class="row">
                        <div class="col-md-5">
                            <label class="col-md-4 control-label"><s:text name="user.id"/></label>
                            <div class="col-md-5">
                                <s:textfield name="ug_search_user_id" id="ug_search_user_id" cssClass="form-control" value="%{ug_search_user_id}" />
                            </div>
                        </div>
                        <div class="col-md-5">
                            <label class="col-md-4 control-label"><s:text name="user.name"/></label>
                            <div class="col-md-5">
                                <s:textfield name="ug_search_user_name" id="ug_search_user_name" cssClass="form-control" value="%{ug_search_user_name}" />
                            </div>
                        </div>
                        <div class="col-md-2">
                            <button class="btn btn-primary" type="submit" name="searchUserBtn" id="searchUserBtn" onclick="searchUser();"><i class="fa fa-search"></i><s:text name="button.search"/></button>
                        </div>
                    </div>
                </div>
            </div>
            <div class="row">
                <div class="col-md-8 form-row-margin">
                    <s:if test="has_right('loadAddUserPage')">
                        <button class="btn btn-default" type="submit" name="action:loadAddUserPageUserGroup" id="loadAddUserPageUserGroup"><i class="fa fa-plus"></i><s:text name="button.add.user"/></button>  
                    ...
                    <s:if test="has_right('processDeleteUser')">
                        <button class="btn btn-default" type="submit" name="action:processDeleteUserUserGroup" id="processDeleteUserUserGroup"><i class="fa fa-trash-o"></i><s:text name="button.delete.user"/></button>
                ...
                <div class="col-md-4 text-right">
                    <button class="btn btn-default" type="submit" name="action:goEditPageUserGroup" id="goEditPageUserGroup"><i class="fa fa-arrow-left"></i><s:text name="button.back"/></button>  
                        ...
                        <table class="table table-sds table-condensed table-striped table-hover" cellspacing="1" cellpadding="1"  width="100%">
                            <thead>
                                <tr>
                                    ...
                                    <th width="100">Primary Contact</th>
                                </tr>
                            </thead>
                            <tbody>
                                <s:if test="userList != null && userList.size > 0">
                                    <s:iterator value="userList" status="userStatus" var="userGroupUser">
                                        <tr class="<s:if test="#userStatus.odd == true ">odd</s:if><s:else>even</s:else>">
                                            ...
                                            <td width="100"><s:property value="%{groupUser.us_user_id}" /></td>
                                            <td width="100"><s:property value='%{groupUser.us_user_name}' /></td>
                                            <td width="100">
