...
<html>
    ...
    <body>
        <form id="uppy3Form" action="uppy3SaveApplicationSample" method="post">
            <div class="panel panel-default">
                <div class="panel-heading">
                    <h4>Page Title <small>Edit</small><s:property value="yourParentModel.ID"/></h4>
                </div>
                ...
                <div class="row form-horizontal form-group">
                    ...
                    <div class="col-md-5">
                        <button type="button" class="btn btn-primary" name="" id="actionName" onclick="return submitForm_bshor('uppy3Form');">
                            <i class="fa fa-save"></i>Save Uppy3 Form
                        </button>
                    </div>
                </div>
            </div>
