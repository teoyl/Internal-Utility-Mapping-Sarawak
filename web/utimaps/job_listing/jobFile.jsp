<%-- 
    Document   : jobFile
    Created on : Aug 9, 2024, 10:52:35 AM
    Author     : User
--%>
...
<div class="accordion-item">
    <h2 class="accordion-header" id="flush-headingFiles">
        <button class="accordion-button collapsed fw-bold text-uppercase" type="button" data-bs-toggle="collapse" data-bs-target="#flush-collapseFiles" aria-expanded="false" aria-controls="flush-collapseFiles">
            <i class="far fa-file-alt me-2 fs-2"></i>FILES (<s:property value="model.usj_no"/>) 
        </button>
    </h2>
                    ...
                    <div class="navbar-collapse" id="navbarVerticalCollapse">
                        <div class="navbar-vertical-content scrollbar">
                            <ul class="navbar-nav flex-column mb-3" id="navbarVerticalNav">
                                ...
                                <li class='nav-item '>   
                                    <a class='nav-link dropdown-indicator' href='#USJ' role='button' data-bs-toggle='collapse' aria-expanded='false' aria-controls='USJ'>      
                                        <div class="d-flex align-items-center">
                                            <span class='nav-link-icon'><i class="fas fa-folder fs-2"></i></span>
                                            <span class="nav-link-text ps-1">Submission of Utility Survey</span>
                                        </div>   
                                    </a>      
                                    <ul class='nav collapse' id='USJ'>    
                                        <li class='nav-item'>
                                            <a class='file-submenu' onclick="viewFile('U10'); return false;">
                                                <div class="d-flex align-items-center">
                                                    <span class='nav-link-icon' id="U10"><i class="fas fa-folder fs-2"></i></span>
                                                    <span class="nav-link-text ps-1">Control Survey</span></div>
                                            </a>
                                        </li>    
                                        <li class='nav-item'>
                                            <a class='file-submenu' onclick="viewFile('U20'); return false;">
                                                <div class="d-flex align-items-center">
                                                    <span class='nav-link-icon' id="U20"><i class="fas fa-folder fs-2"></i></span>
                                                    <span class="nav-link-text ps-1">Utility Survey</span>
                                                </div>
                                            </a>
                                        </li>
                                    </ul>
