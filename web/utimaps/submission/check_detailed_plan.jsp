<%-- 
    Document   : check_detailed_plan
    Created on : Jul 7, 2024, 11:35:16 PM
    Author     : yonglai
--%>
...
<!--<div id="pastChecklistDiv"><jsp:include page="../job_listing/modalPastChecklist.jsp"></jsp:include></div>-->     
