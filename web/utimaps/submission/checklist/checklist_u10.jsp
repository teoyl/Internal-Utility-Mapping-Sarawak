<%-- 
    Document   : checklist_u10
    Created on : Jun 12, 2024, 2:21:11 PM
    Author     : yonglai
--%>
...
<h5 class="p-1 border-bottom border-bottom-lg-1 bg-secondary text-white mb-0"><s:text name="utimaps.checklist.u10" /></h5>
<div class="table-responsive">
    <table class="table table-responsivetable-hover table-striped overflow-hidden " id="checklist_table">
        <thead>
            <tr>
        ...
        <tbody>
            <s:if test="model.u10ChecklistSetupModel.checklistItemList.size() > 0">
                <s:iterator value="model.u10ChecklistSetupModel.checklistItemList" status="listStatus" var="checklistItem">
                    <tr class="<s:if test="#listStatus.odd == true ">odd</s:if><s:else>even</s:else>">
                        <s:hidden name="model.u10ChecklistSetupModel.checklistItemList[%{#listStatus.index}].checklistResultList[0].cl_id" value="%{#checklistItem.checklistResultList[0].cl_id}" />
                        <s:hidden name="model.u10ChecklistSetupModel.checklistItemList[%{#listStatus.index}].checklistResultList[0].case_id" value="%{model.job_id}" />
                        <s:hidden name="model.u10ChecklistSetupModel.checklistItemList[%{#listStatus.index}].checklistResultList[0].check_id" value="%{model.u10ChecklistModel.check_id}" />
                        <s:hidden name="model.u10ChecklistSetupModel.checklistItemList[%{#listStatus.index}].checklistResultList[0].ci_id" value="%{#checklistItem.ci_id}" />
                        <td colspan="2" class="col-md-3 col-xs-3">
                            <div class="d-block">
                                <s:hidden name="model.u10ChecklistSetupModel.checklistItemList[%{#listStatus.index}].checklistResultList[0].ci_desc" value="%{#checklistItem.ci_desc}" />
                            ...
                            <div class="d-flex align-items-center mt-1">
                                ...
                                <div class="col-md-9 ms-2">
                                    <p class="checklist-file text-truncate max-w-200">
                                        <s:hidden name="model.u10ChecklistSetupModel.checklistItemList[%{#listStatus.index}].checklistFileModelList[0].file_id" value="%{#checklistItem.checklistFileModelList[0].file_id}" />
                        ...
                        <td class="col-md-2 col-xs-2">
                            ...
                            <div class="form-check">
                                <input class="u10checklistform u20checklistform form-check-input" id="cl_result_c_<s:property value='%{#checklistItem.id}' />" type="radio" name="model.u10ChecklistSetupModel.checklistItemList[<s:property value='%{#listStatus.index}' />].checklistResultList[0].cl_result" value="C" 
                                    <s:if test ='%{#checklistItem.ci_datatype.equals("SJI")}'>Checked disabled = "true"</s:if>
                                    <s:else>
                                        <s:if test='%{#checklistItem.checklistResultList[0].cl_result.equals("C")}'>Checked</s:if> 
                                    </s:else>
                                />
                            ...
                            <div class="form-check">
                                <input class="u10checklistform u20checklistform form-check-input" id="cl_result_e_<s:property value='%{#checklistItem.id}' />" type="radio" name="model.u10ChecklistSetupModel.checklistItemList[<s:property value='%{#listStatus.index}' />].checklistResultList[0].cl_result" value="E" 
                                    <s:if test ='%{#checklistItem.ci_datatype.equals("SJI")}'>disabled = "true"</s:if>
                                    <s:else>
                                        <s:if test='%{#checklistItem.checklistResultList[0].cl_result.equals("E")}'>Checked</s:if> 
                                    </s:else>
                                />
                            ...
                            <div class="form-check">
                                <input class="u10checklistform u20checklistform form-check-input" id="cl_result_n_<s:property value='%{#checklistItem.id}' />" type="radio" name="model.u10ChecklistSetupModel.checklistItemList[<s:property value='%{#listStatus.index}' />].checklistResultList[0].cl_result" value="N" 
                                    <s:if test ='%{#checklistItem.ci_datatype.equals("SJI")}'>disabled = "true"</s:if>
                                    <s:else>
                        ...
                        <td class="col-md-5 col-xs-5">
                            <s:textarea theme="simple" name="model.u10ChecklistSetupModel.checklistItemList[%{#listStatus.index}].checklistResultList[0].cl_remarks" value="%{#checklistItem.checklistResultList[0].cl_remarks}" cssClass="form-control" rows="5" maxlength="1000" readonly="%{#checklistItem.ci_datatype.equals('SJI') ? 'true' : 'false'}" />
                        </td>
                            ...
                            <s:if test="#checklistItem.checklistResultList[0].checklistSupportFileList.size() > 0">
                                <s:iterator value = "#checklistItem.checklistResultList[0].checklistSupportFileList" status="supportFileStatus" var="supportFile">
                                    ...
                                    <s:include value="/base/uppyIncludeSingleFile_utimaps.jsp">
                                        ...
                                        <s:param name="checklist_type">U10</s:param>
                                    </s:include>
                                </s:iterator>
                            </s:if>
                            <s:else>
