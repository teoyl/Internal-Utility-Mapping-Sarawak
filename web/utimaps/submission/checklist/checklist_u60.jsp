<%-- 
    Document   : checklist_u60
    Created on : Apr 4, 2025, 9:52:54 AM
    Author     : yonglai
--%>
...
<h5 class="p-1 border-bottom border-bottom-lg-1 bg-secondary text-white mb-0"><s:text name="utimaps.checklist.u60" /></h5>
<div class="table-responsive scrollbar" >
    <table class="table table-hover table-striped overflow-hidden " id="checklist_table">
        ...
        <tbody>
            <s:if test="model.u60ChecklistSetupModel.checklistItemList.size() > 0">
                <s:iterator value="model.u60ChecklistSetupModel.checklistItemList" status="listStatus" var="checklistItem">
                    <tr class="<s:if test="#listStatus.odd == true ">odd</s:if><s:else>even</s:else>">
                        <s:hidden name="model.u60ChecklistSetupModel.checklistItemList[%{#listStatus.index}].checklistResultList[0].cl_id" value="%{#checklistItem.checklistResultList[0].cl_id}" />
                        <s:hidden name="model.u60ChecklistSetupModel.checklistItemList[%{#listStatus.index}].checklistResultList[0].case_id" value="%{model.job_id}" />
                        <s:hidden name="model.u60ChecklistSetupModel.checklistItemList[%{#listStatus.index}].checklistResultList[0].check_id" value="%{model.u60ChecklistSetupModel.check_id}" />
                        <s:hidden name="model.u60ChecklistSetupModel.checklistItemList[%{#listStatus.index}].checklistResultList[0].ci_id" value="%{#checklistItem.ci_id}" />
                        <td colspan="2" class="col-md-3">
                            <div class="d-block">
                                <s:hidden name="model.u60ChecklistSetupModel.checklistItemList[%{#listStatus.index}].checklistResultList[0].ci_desc" value="%{#checklistItem.ci_desc}" />
                            ...
                            <div class="d-flex align-items-center mt-1">
                                ...
                                <div class="col-md-9">
                                    <p class="checklist-file text-truncate max-w-150">
                                        <s:hidden name="model.u60ChecklistSetupModel.checklistItemList[%{#listStatus.index}].checklistFileModelList[0].file_id" value="%{#checklistItem.checklistFileModelList[0].file_id}" />
                        ...
                        <td class="col-md-2">
                            <div class="form-check">
                                <input class="u60checklistform form-check-input" id="cl_result_c_<s:property value='%{#checklistItem.id}' />" type="radio" name="model.u60ChecklistSetupModel.checklistItemList[<s:property value='%{#listStatus.index}' />].checklistResultList[0].cl_result" value="C" <s:if test='%{#checklistItem.checklistResultList[0].cl_result.equals("C")}'>Checked</s:if> />
                            ...
                            <div class="form-check">
                                <input class="u60checklistform form-check-input" id="cl_result_e_<s:property value='%{#checklistItem.id}' />" type="radio" name="model.u60ChecklistSetupModel.checklistItemList[<s:property value='%{#listStatus.index}' />].checklistResultList[0].cl_result" value="E" <s:if test='%{#checklistItem.checklistResultList[0].cl_result.equals("E")}'>Checked</s:if> />
                            ...
                            <div class="form-check">
                                <input class="u60checklistform form-check-input" id="cl_result_n_<s:property value='%{#checklistItem.id}' />" type="radio" name="model.u60ChecklistSetupModel.checklistItemList[<s:property value='%{#listStatus.index}' />].checklistResultList[0].cl_result" value="N" <s:if test='%{#checklistItem.checklistResultList[0].cl_result.equals("N")}'>Checked</s:if> />
                        ...
                        <td class="col-md-5">
                            <s:textarea theme="simple" name="model.u60ChecklistSetupModel.checklistItemList[%{#listStatus.index}].checklistResultList[0].cl_remarks" value="%{#checklistItem.checklistResultList[0].cl_remarks}" cssClass="form-control" rows="5" maxlength="1000"/>
                        </td>
                            ...
                            <s:if test="#checklistItem.checklistResultList[0].checklistSupportFileList.size() > 0">
                                <s:iterator value = "#checklistItem.checklistResultList[0].checklistSupportFileList" status="supportFileStatus" var="supportFile">
                                    ...
                                    <s:include value="/base/uppyIncludeSingleFile_utimaps.jsp">
                                        ...
                                        <s:param name="checklist_type">U60</s:param>
                                    </s:include>
                                </s:iterator>
                            </s:if>
                            <s:else>
