...
<div class="accordion-item">
    <h2 class="accordion-header" id="flush-headingUSCS10H">
        <button class="accordion-button <s:if test='!activeAccordion.equals("2")'>collapsed</s:if> fw-bold text-uppercase" type="button" data-bs-toggle="collapse" data-bs-target="#flush-collapseUSCS10H" aria-expanded="false" aria-controls="flush-collapseUSCS10H">
            <i class="fas fa-tasks me-2"></i><s:text name = "utimaps.form.submission.uscs10" />
        </button>
    </h2>

    <div id="flush-collapseUSCS10H" class="accordion-collapse collapse <s:if test='activeAccordion.equals("2")'>show</s:if>" aria-labelledby="flush-headingUSCS10H" data-bs-parent="#accordionFlushApplication">
            <div class="accordion-body">
            <s:if test='fileID==NULL'>
                <IFRAME id="pdfviewer" src="pdfViewerSubmission?pJobId=${model.job_id}&pType=USCS10H&cType=${checklistType}&output=embed"  WIDTH=100% HEIGHT=500  align="center" >
                </IFRAME>
            </s:if><s:else>
            ...
            <form action="" method="post" id="USCS10Form" enctype="multipart/form-data">
                ...
                <s:hidden name="processType" id="processType" value="172"/> 
                ...
                <s:if test='(!isSigned(model.job_id, "USCS10H")) && model.wf_status_2.equals("172")'>
                ...
                <div class="row">
                    <div class="col-md-12 text-end mb-3">
                        <s:if test='rightToUpdate && model.wf_status_2.equals("172")'>
                            <s:if test='(!isSigned(model.job_id, "USCS10H")) && model.wf_status_2.equals("172")'>
...
<script nonce="r4DjhKbfO5ry">
    $(document).ready(function () {
        scrollToView("flush-collapseUSCS10H");
    });
