                    ...
                    <ul class="nav nav-tabs nav-justified" role="tablist" id="myTab">
                        ...
                        <%--<s:iterator value="listJobtobeGrab" status="jobPoolStatus" var="iteratorJobPool">--%>
                            ...
                            <li role="presentation" class="li_tab1 nav-item">
                                <a href="#tab1" aria-controls="tab1" role="tab" data-toggle="tab" class="nav-link a_tab1 unassigned-tab" id="li_tab1">
                            ...
                            <li role="presentation" class=" li_tab2 nav-item">
                                <a href="#tab2" aria-controls="tab2" role="tab" data-toggle="tab" class="nav-link  a_tab2 in-progress-tab"   id="li_tab2">
                        ...
                        <li role="presentation" class="li_tab3 nav-item">
                            <a href="#tab3" aria-controls="tab3" role="tab" data-toggle="tab" class="nav-link a_tab3 completed-today-tab" id="li_tab3">
                        ...
                        <!--2019.01.09 Edited by IvyL-->
                         <li role="presentation" class="li_tab4 nav-item">
                            <a href="#tab4" aria-controls="tab4" role="tab" data-toggle="tab" class="nav-link a_tab4 completed-30-tab" id="li_tab4">
...
<!--                        <li role="presentation">
                    ...
                    <div class="tab-content"  id="jobContentDiv">
                        ...
                        <div role="tabpanel" class="tab-pane fade in" id="tab2">
                               <jsp:include page="b4_jobInProgress.jsp"></jsp:include> 
                        </div>
        ...
        <s:if test="genListBySystem(#iteratorJobPool.get('wf_subsystem')) > 0">
            <s:iterator value="listJobBySystem" status="jobProgressStatus" var="iteratorJobBySystem">
                <div id="caseDetail_${jobProgressStatus.index}" class="modal fade hide-disp" tabindex="-1" >
                    <div class="modal-dialog">
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                  <table id="resultCasea" class="table table-striped  " >
                                    <thead>
                                        <tr>
                                            <th width="2%"></th>
