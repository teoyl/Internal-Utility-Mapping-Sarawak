...
//            });
            if($('.completeJobCount').val() > 0){
                $('#myTable${strDurationValue}').dataTable({
                    "paging":   true,
                    "columnDefs" : [{"targets":1, "type":"date"},{"targets":6, "type":"date"}]
                });
            }
        });
        </script>
...
<s:if test='istrSystemId.equals("COMPLETED")'> 
    <div class="table-responsive">
        <table class="table table-espa table-condensed table-striped" id="myTable${strDurationValue}" cellspacing="0" cellpadding="0" width="100%">
            <thead>
...
<s:else>
<div class="table-responsive">
    <table class="table table-espa table-condensed table-striped" id="myTable" cellspacing="0" cellpadding="0" width="100%">
        <thead>
            <tr class="jobHeader_1">
